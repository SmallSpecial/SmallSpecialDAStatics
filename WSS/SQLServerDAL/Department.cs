...
namespace WSS.SQLServerDAL
{
	...
	public partial class Department:IDepartment
	{
		...
		public int Add(WSS.Model.Department model)
		{
			...
			strSql.Append("F_ParentID,F_DepartName)");
			strSql.Append(" values (");
			strSql.Append("@F_ParentID,@F_DepartName)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ParentID", SqlDbType.Int,4),
					new SqlParameter("@F_DepartName", SqlDbType.NChar,10)};
		...
		public WSS.Model.Department GetModel(int F_DepartID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_DepartID,F_ParentID,F_DepartName from T_Department ");
			strSql.Append(" where F_DepartID=@F_DepartID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_DepartID", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_DepartID,F_ParentID,F_DepartName ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" F_DepartID,F_ParentID,F_DepartName ");
			strSql.Append(" FROM T_Department ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
