...
jQuery(function (e) {
    ...
    for (var s in i)
        if (s in ace) {
            var n = i[s];
            n !== !1 && (null === n ? n = [jQuery] : n instanceof Array ? n.unshift(jQuery) : n = [jQuery, n],
            ace[s].apply(null, n))
        }
}),
...
ace.general_things = function (e) {
    ...
    e(document).on("click", ".dropdown-navbar .nav-tabs", function (a) {
        ...
        (t = e(a.target).closest("[data-toggle=tab]")) && t.length > 0 && (t.tab("show"),
        a.preventDefault())
    }),
    ...
    if (t.length > 0) {
        ...
        e(window).on("scroll.scroll_btn", function () {
            ...
            e > parseInt(a / 4) || e > 0 && s >= a && a + e >= s - 1 ? i || (t.addClass("display"),
            i = !0) : i && (t.removeClass("display"),
            i = !1)
    ...
    ace.vars.ios_safari && e(document).on("ace.settings.ios_fix", function (a, t, i) {
        "navbar_fixed" == t && (e(document).off("focus.ios_fix blur.ios_fix", "input,textarea,.wysiwyg-editor"),
        1 == i && e(document).on("focus.ios_fix", "input,textarea,.wysiwyg-editor", function () {
...
ace.helper.collapsible = function () {
    var e;
    return null != $("#sidebar.navbar-collapse") && null != (e = $('.navbar-toggle[data-target*=".sidebar"]')) && e.scrollHeight > 0
}
,
                ...
                n.on(a, function (a) {
                    function r(e) {
                        if (c) {
                            ...
                            c && o && (u = 0,
                            h = 0,
                            d = Math.abs(h = c.coords[1] - o.coords[1]) > s && Math.abs(u = c.coords[0] - o.coords[0]) <= Math.abs(h) ? h > 0 ? "up" : "down" : Math.abs(u = c.coords[0] - o.coords[0]) > s && Math.abs(h) <= Math.abs(u) ? u > 0 ? "left" : "right" : !1,
                            d !== !1)) {
                                var t = {
                                    cancel: !1
                                };
...
ace.handle_side_menu = function (e) {
    ...
    e(document).on(ace.click_event + ".ace.menu", "#menu-toggler", function () {
        ...
        ace.settings.sidebar_collapsed.call(this, ace.vars.minimized),
        ace.vars.old_ie && ace.helper.redraw(a.get(0)))
        ...
        var t = e(this).find(ace.vars[".icon"])
          , i = t.attr("data-icon1")
          , s = t.attr("data-icon2");
        a.hasClass("responsive-min") ? (t.removeClass(i).addClass(s),
        a.removeClass("responsive-min"),
        a.addClass("display responsive-max"),
        ace.vars.minimized = !1) : (t.removeClass(s).addClass(i),
        a.removeClass("display responsive-max"),
        a.addClass("responsive-min"),
        ace.vars.minimized = !0),
        ...
        if (s && 0 != s.length) {
            ...
            if (s.hasClass("dropdown-toggle")) {
                ...
                0 == r.scrollHeight && e(c).find("> .open > .submenu").each(function () {
                    this == r || e(this.parentNode).hasClass("active") || (o -= this.scrollHeight,
                    ace.submenu.hide(this, l))
                });
                var d = 0;
            ...
            if (t && "false" !== s.attr("data-link"))
                return document.location = s.attr("href"),
                a.preventDefault(),
                !1
        }
    })
        ...
        !r.isDefaultPrevented()) {
            ...
            e.ajax({
                ...
                if (o.length > 0) {
                    ...
                    n && ace.helper.sidebar_scroll.scroll_to_active())),
                    c && (l = i(o)))
                }
...
ace.submenu = {
    show: function (e, a) {
        ...
        if (s.trigger(t = i.Event("show.ace.submenu")),
    ...
    hide: function (e, a) {
        var t, i = window.jQuery, s = i(e);
        if (s.trigger(t = i.Event("hide.ace.submenu")),
        t.isDefaultPrevented())
            return !1;
        s.css({
            height: e.scrollHeight,
    ...
    if (e.fn.ace_scroll) {
        ...
        if (l && c) {
            ...
            , T = k(), j = i.hasClass("h-sidebar"), H = ace.helper.sidebar_scroll = {
                ...
                initiate: function (a) {
                    if (!b && T) {
                        ...
                        _ && (s.parent().prepend(r).wrapInner("<div />"),
                        s = s.parent()),
                        y && (s.append(n),
                        s.closest(".nav-wrap").addClass("nav-wrap-t")),
                        s.css({
                            position: "relative"
                        }),
                        ...
                        if (s.on("ace_drag.nav", function (e) {
                            ...
                            if ("up" == e.direction || "down" == e.direction) {
                                ...
                                Math.abs(a) > 2 && (a = 2 * a),
                                0 != a && (i.scrollTop = i.scrollTop + a,
                                c.style.top = -1 * i.scrollTop + "px")
                        }
                        }),
                        ...
                        if (b = !0,
                        1 == a && (H.reset(),
                        w && H.scroll_to_active(),
                        w = !1),
                        "number" == typeof C && C > 0 && (s.css({
                ...
                scroll_to_active: function () {
                    if (g && g.is_active())
                        try {
                            ...
                            ace.vars.minimized && !ace.vars.collapsible ? e = a.find("> .active") : (e = s.find("> .active.hover"),
                            0 == e.length && (e = s.find(".active:not(.open)")));
                            var t = e.outerHeight();
                            a = a.get(0);
            ...
            e(document).on("settings.ace.scroll", function (e, a) {
                "sidebar_collapsed" == a && T ? H.reset() : ("sidebar_fixed" === a || "navbar_fixed" === a) && (T = k(),
                T && !m ? H.reset() : T || H.disable())
            }),
...
ace.sidebar_hoverable = function (e, a) {
    function t(a) {
        ...
        var s = null;
        ace.vars.minimized && (s = a.parentNode.find(".menu-text")) && s.style.removeProperty("margin-top");
        var n = t.offset()
        ...
        if ((v = p - (f + r - 50)) > 0)
            if (u > h - v && n.top - v > c)
                a.style.top = "auto",
                a.style.bottom = "-10px",
                s && (s.style.marginTop = -(h - 50) + "px",
                o = !0);
            else {
                n.top - v < c && (v = n.top - c),
                p - v < n.top + u && (v -= u);
                var g = s ? 40 : 20;
                v > g && (a.style.top = -v + "px",
                s && (s.style.marginTop = -v + "px",
                o = !0))
            }
        var m = this.className.lastIndexOf("pull_up");
        if (o) {
            if (-1 == m && (this.className = this.className + " pull_up"),
            i) {
                var b = h + n.top - v;
                0 > f - b ? e(a).css({
                    "max-height": h + f - b - 50,
...
ace.widget_boxes = function (e) {
    e(document).on("hide.bs.collapse show.bs.collapse", function (a) {
        ...
        0 != i.length && i.find(ace.vars[".icon"]).each(function () {
            ...
            return (s = i.attr("data-icon-show")) ? n = i.attr("data-icon-hide") : (t = i.attr("class").match(/fa\-(.*)\-(up|down)/)) && (s = "fa-" + t[1] + "-down",
            n = "fa-" + t[1] + "-up"),
            s ? ("show" == a.type ? i.removeClass(s).addClass(n) : i.removeClass(n).addClass(s),
            !1) : void 0
        })
    });
    var a = function (a) {
        ...
        this.toggle = function (e, a) {
            ...
            if ("undefined" == typeof a && (a = t.find("> .widget-header a[data-action=collapse]").eq(0),
            0 == a.length && (a = null)),
            a) {
                s = a.find(ace.vars[".icon"]).eq(0);
                var o, l = null, c = null;
                (l = s.attr("data-icon-show")) ? c = s.attr("data-icon-hide") : (o = s.attr("class").match(/fa\-(.*)\-(up|down)/)) && (l = "fa-" + o[1] + "-down",
                c = "fa-" + o[1] + "-up")
            }
            var d = 250
              , u = 200;
            "show" == n ? (s && s.removeClass(l).addClass(c),
            i.hide(),
            t.removeClass("collapsed"),
            i.slideDown(d, function () {
                t.trigger(r + ".ace.widget")
            })) : (s && s.removeClass(c).addClass(l),
        ...
        this.fullscreen = function () {
            var e = this.$box.find("> .widget-header a[data-action=fullscreen]").find(ace.vars[".icon"]).eq(0)
              , a = null
              , t = null;
            (a = e.attr("data-icon1")) ? t = e.attr("data-icon2") : (a = "fa-expand",
            t = "fa-compress"),
            this.$box.hasClass("fullscreen") ? (e.addClass(a).removeClass(t),
            this.$box.removeClass("fullscreen")) : (e.removeClass(a).addClass(t),
    ...
    e(document).on("click.ace.widget", ".widget-header a[data-action]", function (t) {
        ...
        if (0 != s.length && !s.hasClass("ui-sortable-helper")) {
            ...
            if ("collapse" == r) {
                ...
                if (s.trigger(o = e.Event(l + ".ace.widget")),
                o.isDefaultPrevented())
                    return;
                n.toggle(l, i)
            } else if ("close" == r) {
                var o;
                if (s.trigger(o = e.Event("close.ace.widget")),
                o.isDefaultPrevented())
                    return;
                n.close()
            } else if ("reload" == r) {
                i.blur();
                var o;
                if (s.trigger(o = e.Event("reload.ace.widget")),
                o.isDefaultPrevented())
                    return;
                n.reload()
            } else if ("fullscreen" == r) {
                var o;
                if (s.trigger(o = e.Event("fullscreen.ace.widget")),
                o.isDefaultPrevented())
                    return;
                n.fullscreen()
            } else
