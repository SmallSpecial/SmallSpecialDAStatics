...
(function ($) {
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        // if not query should clear the grid,¡£¡£¡£¡££¿£¿£¿£¿
        return;
        var m = [];
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        if (!this.options.pagination || this.options.sidePagination === 'server') {
            this.pageFrom = 1;
            this.pageTo =data==undefined?0: data.length;
        }
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            ...
            options = $.extend(options, option);//query collection is null;
            //if (options.data) {//Êý¾ÝË¢ÐÂ
