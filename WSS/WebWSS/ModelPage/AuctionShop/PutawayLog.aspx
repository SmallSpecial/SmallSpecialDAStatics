<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PutawayLog.aspx.cs" Inherits="WebWSS.ModelPage.AuctionShop.PutawayLog" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <%--<asp:Label runat="server" Text=" <%$Resources:Language,LblCorpsbattleRank %>"></asp:Label>--%>
                <asp:Label runat="server" Text="<%$Resources:Language,PutawayLog %>"></asp:Label>
            </div>
            <div class="search">
