<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseLog.aspx.cs" Inherits="WebWSS.ModelPage.AuctionShop.PurchaseLog" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <%--<asp:Label runat="server" Text=" <%$Resources:Language,LblCorpsbattleRank %>"></asp:Label>--%>
                <asp:Label runat="server" Text="<%$Resources:Language,PurchaseLog %>"></asp:Label>
            </div>
            <div class="search">
            ...
            <asp:DropDownList ID="DropDownListArea2" runat="server" Width="120" AutoPostBack="False"
                ...
                <asp:Label ID="lblPARA_1" runat="server" Text="获取途径" Visible="false"></asp:Label>
                <asp:TextBox ID="txtPARA_1" runat="server" Visible="false"></asp:TextBox>
                <asp:Label ID="lblOPID" runat="server" Text="货币类型" Visible="false"></asp:Label>
                <asp:DropDownList ID="ddlOPID" runat="server" Visible="false">
                    <asp:ListItem Text="" Value=""></asp:ListItem>
                    <asp:ListItem Text="10037" Value="10037"></asp:ListItem>
                    <asp:ListItem Text="10038" Value="10038"></asp:ListItem>
                </asp:DropDownList>
            ...
            <div class="gridv" style="margin-right: 100px">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PARA_1" HeaderText="<%$Resources:Language,LblRoleLevel %>" />
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language,CDK_Remark %>">
                            <ItemStyle />
                            <ItemTemplate>
                                <%#GetOPBakFormate(Eval("OP_BAK").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="OP_TIME" HeaderText="<%$Resources:Language,LblOpTime %>" />
                    </Columns>
        ...
        <span style="display: none">
            <asp:Label ID="lblDebug" runat="server" Text="" ForeColor="#FF6600"></asp:Label></span>
    </form>
</body>
</html>
