<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoldOutLog.aspx.cs" Inherits="WebWSS.ModelPage.AuctionShop.SoldOutLog" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <%--<asp:Label runat="server" Text=" <%$Resources:Language,LblCorpsbattleRank %>"></asp:Label>--%>
                <asp:Label runat="server" Text="<%$Resources:Language,SoldOutLog %>"></asp:Label>
            </div>
            <div class="search">
