<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchLog.aspx.cs" Inherits="WebWSS.ModelPage.AuctionShop.SearchLog" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <%--<asp:Label runat="server" Text=" <%$Resources:Language,LblCorpsbattleRank %>"></asp:Label>--%>
                <asp:Label runat="server" Text="<%$Resources:Language,LblSearchLog %>"></asp:Label>
            </div>
            <div class="search">
