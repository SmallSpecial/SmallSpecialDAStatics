<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepositConfigLog.aspx.cs" Inherits="WebWSS.ModelPage.GiftConfig.DepositConfigLog" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <div style="margin-top: 20px; margin-bottom: 20px;">
                <asp:Label runat="server" ID="lblGiftAward" Text="DepositConfigLog"></asp:Label>
            </div>
