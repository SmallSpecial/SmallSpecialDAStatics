<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiftList.aspx.cs" Inherits="WebWSS.ModelPage.GiftConfig.GiftList" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <div style="margin-top: 20px; margin-bottom: 20px;">
                <asp:Label runat="server" ID="lblGiftAward" Text="礼包信息列表"></asp:Label>
            </div>
            <div style="margin-top: 20px; margin-bottom: 20px;">
