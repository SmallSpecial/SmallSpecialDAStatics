<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHis.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHis" %>
     ...
     <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" ID="lblGiftAward" Text="<%$Resources:Language,BtnAwardWorkOrderPoolHis %>"></asp:Label>
        </div>
        <div class="gridv" style="overflow-y:auto;height:90%">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="10" ShowFooter="false" AllowPaging="true" HeaderStyle-CssClass="Freezing">
                <Columns>
                    ...
                    <asp:BoundField DataField="F_TUseData" HeaderText="<%$Resources:Language,LblGiftUserInfo %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_Note" HeaderText="<%$Resources:Language,LblMailContent %>" ItemStyle-Width="500px" />
