<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisUnLockRole.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisUnLockRole" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblUnLockRole %>"></asp:Label>
        </div>
        <div class="gridv">
