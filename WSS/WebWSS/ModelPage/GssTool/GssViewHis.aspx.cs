...
{
    public partial class GssViewHis : Admin_Page
    {
        #region 属性
        ...
        {
            string sql = "";
            sql = "SELECT TOP 200 * FROM [T_Tasks] WHERE [F_Type]=20000214 AND CONVERT(VARCHAR(100),F_CreatTime,23)>='2017-11-07' ORDER BY F_ID DESC";
            try
            {
                ds = DBHelperGSSDB.Query(sql);
