<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisLockRole.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisLockRole" %>
    ...
    <div class="main">
      <div class="itemtitle">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblLockRole %>"></asp:Label>
        </div>
        <div class="gridv">
