<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisLockUser.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisLockUser" %>
    ...
    <div class="main">
     <div class="itemtitle">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblLockUser %>"></asp:Label>
        </div>
        <div class="gridv">
