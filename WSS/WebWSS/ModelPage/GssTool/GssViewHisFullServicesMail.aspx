<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisFullServicesMail.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisFullServicesMail" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" ID="lblGiftAward" Text="<%$Resources:Language,BtnFullServerMailHis %>"></asp:Label>
        </div>
        <div class="gridv" style="overflow-y:auto;height:90%">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_ID" HeaderText="<%$Resources:Language,Lbl_Order %>" ItemStyle-Width="100px" />
                    <asp:BoundField DataField="F_Title" HeaderText="<%$Resources:Language,Lbl_StartNoticeTitle %>" ItemStyle-Width="100px" />
                    <asp:BoundField DataField="F_GPeopleName" HeaderText="<%$Resources:Language,LblSendPeople %>" ItemStyle-Width="50px" />
                    <asp:BoundField DataField="F_URInfo" HeaderText="<%$Resources:Language,LblGiftInfo %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_TUseData" HeaderText="<%$Resources:Language,LblGiftBattleInfo %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_OAlwaysPlace" HeaderText="<%$Resources:Language,LblMinAndMax %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_Note" HeaderText="<%$Resources:Language,LblMailContent %>" ItemStyle-Width="400px" />
                    <asp:BoundField DataField="F_COther" HeaderText="<%$Resources:Language,CDK_Remark %>" ItemStyle-Width="400px" />
                    <asp:BoundField DataField="F_CreatTime" HeaderText="<%$Resources:Language,LblStartTime %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_EditTime" HeaderText="<%$Resources:Language,LblEndTime %>" ItemStyle-Width="200px" />
                     <asp:TemplateField HeaderText="<%$Resources:Language,LblOperate %>">
                        ...
                        <ItemTemplate>
                            <table class="templete">
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="lbtDelete" runat="server" _InfoID='<%#Eval("F_ID")%>' OnClientClick="return confirm('삭제하시겠습니까?')" Text="<%$Resources:Language,LblDelete %>" OnClick="lbtDelete_Click">
                                        </asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
