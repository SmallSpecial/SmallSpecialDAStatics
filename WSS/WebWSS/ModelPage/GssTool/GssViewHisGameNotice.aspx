<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisGameNotice.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisGameNotice" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,BtnCallTankHis %>"></asp:Label>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_URInfo" HeaderText="<%$Resources:Language,LblNoticeInfo %>" ItemStyle-Width="400px" />
                    <asp:BoundField DataField="F_TUseData" HeaderText="<%$Resources:Language,LblBattleZoneInfo %>" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="F_Note" HeaderText="<%$Resources:Language,CDK_Remark %>" ItemStyle-Width="400px" />
                    <asp:BoundField DataField="F_TToolUsed" HeaderText="<%$Resources:Language,Btn_RunStatue %>" />
                    <asp:BoundField DataField="F_CreatTime" HeaderText="<%$Resources:Language,Lbl_CreateTime %>" ItemStyle-Width="200px" />
                     <asp:TemplateField HeaderText="<%$Resources:Language,LblOperate %>">
                        ...
                        <ItemTemplate>
                            <table class="templete">
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="lbtStart" runat="server" _InfoID='<%#Eval("F_ID")%>' OnClientClick="return confirm('确定运行公告?')" Text="<%$Resources:Language,LblRunNotice %>" OnClick="lbtStart_Click">
                                        </asp:LinkButton>
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="lbtStop" runat="server" _InfoID='<%#Eval("F_ID")%>' OnClientClick="return confirm('确定停止公告?')" Text="<%$Resources:Language,Lbl_StopNotice %>" OnClick="lbtStop_Click">
                                        </asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
