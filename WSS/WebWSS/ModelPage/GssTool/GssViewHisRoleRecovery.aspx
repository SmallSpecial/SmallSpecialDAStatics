<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisRoleRecovery.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisRoleRecovery" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblRoleRecovery %>"></asp:Label>
        </div>
        <div class="gridv">
