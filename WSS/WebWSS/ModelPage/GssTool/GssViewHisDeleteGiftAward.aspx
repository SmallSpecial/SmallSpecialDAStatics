<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisDeleteGiftAward.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisDeleteGiftAward" %>
    ...
    <div class="main">
     <div class="itemtitle">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" ID="lblGiftAward" Text="<%$Resources:Language,LblDeleteGiftAward %>"></asp:Label>
        </div>
        <div class="gridv">
