<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisDisRoleChatDel.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisDisRoleChatDel" %>
    ...
    <div class="main">
      <div class="itemtitle">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblDisRoleChatDel %>"></asp:Label>
        </div>
        <div class="gridv">
