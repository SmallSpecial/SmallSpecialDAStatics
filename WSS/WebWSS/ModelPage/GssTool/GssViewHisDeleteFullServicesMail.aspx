<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisDeleteFullServicesMail.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisDeleteFullServicesMail" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" ID="lblGiftAward" Text="<%$Resources:Language,LblDeleteFullServicesMail %>"></asp:Label>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_TaskID" HeaderText="<%$Resources:Language,LblDeleteOrder %>" />
