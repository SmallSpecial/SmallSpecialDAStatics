<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GssViewHisUnLockUser.aspx.cs" Inherits="WebWSS.ModelPage.GssTool.GssViewHisUnLockUser" %>
      ...
      <div class="itemtitle">
       ...
       <div style="margin-top:20px;">
        ...
        <div style="margin-top:20px;margin-bottom:20px;">
            <asp:Label runat="server" Text="<%$Resources:Language,LblUnLockUser %>"></asp:Label>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LockID" HeaderText="<%$Resources:Language,LblUserNo %>" />
                    <asp:BoundField DataField="F_LockName" HeaderText="<%$Resources:Language,UserName %>" />
