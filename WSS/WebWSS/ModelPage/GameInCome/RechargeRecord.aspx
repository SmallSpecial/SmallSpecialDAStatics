<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeRecord.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.RechargeRecord" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="游戏收入"></asp:Label>
            >>
            <asp:Label runat="server" Text="玩家充值记录"></asp:Label>
        </div>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    <asp:BoundField DataField="F_UserID" HeaderText="账号ID" />
                    <asp:BoundField DataField="F_GlobalID" HeaderText="角色ID" />
                    <asp:BoundField DataField="F_ZoneID" HeaderText="区服" />
                    <asp:BoundField DataField="F_ChannelID" HeaderText="渠道" />
                    <asp:BoundField DataField="F_TransactionID" HeaderText="充值订单号" />
                    <asp:BoundField DataField="F_ProductID" HeaderText="商品ID" />
                    <asp:BoundField DataField="F_Price" HeaderText="充值金额" />
                    <asp:BoundField DataField="F_PlayerLevel" HeaderText="等级" />
                    <asp:BoundField DataField="F_InsertTime" HeaderText="充值时间" />
                    <asp:BoundField DataField="F_StoreName" HeaderText="商店名称" />
                    <asp:BoundField DataField="F_DepositResult" HeaderText="充值结果" />
                </Columns>
                <PagerTemplate>
