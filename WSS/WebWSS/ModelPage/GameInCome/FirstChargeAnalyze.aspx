<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstChargeAnalyze.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.FirstChargeAnalyze" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="首充分析"></asp:Label>
        </div>
        <div class="search" style="margin-top: 8px; margin-bottom: 4px;">
            ...
            <%--类型--%>
            <asp:Label runat="server">类型：</asp:Label>
            <asp:DropDownList runat="server" ID="ddlType" Width="80">
                <asp:ListItem Value="0" Text="等级"></asp:ListItem>
                <asp:ListItem Value="1" Text="间隔"></asp:ListItem>
                <asp:ListItem Value="2" Text="金额分布"></asp:ListItem>
            </asp:DropDownList>
            <%--渠道--%>
            <asp:Label runat="server" Visible="false">渠道：</asp:Label>
            <asp:DropDownList runat="server" ID="ddlChannel" Width="80" Visible="false"></asp:DropDownList>
            <%--开始时间--%>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    <asp:BoundField DataField="OrderNum" HeaderText="序号" />
                    <asp:BoundField DataField="Type" HeaderText="类型" />
                    <asp:BoundField DataField="RechargeNumOfPeople" HeaderText="充值人数" />
                </Columns>
                <PagerTemplate>
