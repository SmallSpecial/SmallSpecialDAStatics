<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeRegion.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.RechargeRegion" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="充值区间"></asp:Label>
        </div>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    <asp:BoundField DataField="serialNum" HeaderText="序号" />
                     <asp:TemplateField HeaderText="充值段">
                        <ItemStyle />
                        <ItemTemplate>
                            <%#GetPrice(Eval("serialNum").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="RechargeNumOfPeople" HeaderText="充值人数" />
                    <asp:BoundField DataField="RechargeAmount" HeaderText="充值金额" />
                    <asp:BoundField DataField="ARPU" HeaderText="ARPU" />
                </Columns>
                <PagerTemplate>
