<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeRankList.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.RechargeRankList" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="充值排行榜"></asp:Label>
        </div>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    ...
                    <asp:BoundField DataField="F_GlobalID" HeaderText="角色编号" />
                    ...
                    <asp:BoundField DataField="RechargeNum" HeaderText="充值次数" />
                    <asp:BoundField DataField="RechargeNum" HeaderText="充值次数" />
                    <asp:BoundField DataField="RechargeAmount" HeaderText="充值金额" />
                    <asp:BoundField DataField="LastRechargeTime" HeaderText="最后一次充值时间" />
                    <asp:BoundField DataField="LastLevel" HeaderText="最后一次充值等级" />
                </Columns>
                <PagerTemplate>
