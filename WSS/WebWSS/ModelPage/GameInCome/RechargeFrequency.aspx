<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeFrequency.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.RechargeFrequency" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="充值频次"></asp:Label>
        </div>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    <asp:BoundField DataField="RechargeNumOfPeople" HeaderText="充值总人数" />
                    <asp:BoundField DataField="RechargeNumOfPeople_2" HeaderText="付费两次用户" />
                    <asp:BoundField DataField="RechargeNumOfPeople_3" HeaderText="付费三次用户" />
                    <asp:BoundField DataField="RechargeNumOfPeople_2Lv" HeaderText="两次付费率" />
                    <asp:BoundField DataField="RechargeNumOfPeople_3Lv" HeaderText="三次付费率" />
                </Columns>
                <PagerTemplate>
