<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeLevel.aspx.cs" Inherits="WebWSS.ModelPage.GameInCome.RechargeLevel" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="付费等级"></asp:Label>
        </div>
