...
{
    public partial class ReimburseLog : Admin_Page
    {
        #region 属性
        ...
        public void bind()
        {
            ...
            {
                sqlWhere += " and GlobalID=" + tbRoleID.Text.Trim();
            }
            sql = @"SELECT TOP 500 * FROM [dbo].[T_CostPlayerGoldLog]" + sqlWhere + " ORDER BY AddTime DESC";
            try
            {
