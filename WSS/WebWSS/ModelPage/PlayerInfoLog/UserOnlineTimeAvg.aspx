<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOnlineTimeAvg.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.UserOnlineTimeAvg" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="用户平均在线时长统计"></asp:Label>
        </div>
        <div class="search">
                <asp:Label runat="server" Text="<%$Resources:Language,LblBigZone %>" Visible="false"></asp:Label>
                ...
                <asp:Label runat="server" Text="<%$Resources:Language,LblService %>" Visible="false"></asp:Label>
            ...
            <asp:Label ID="lblPara1" runat="server" Text="用户编号"></asp:Label>
     ...
     <asp:Label ID="lblDeType" runat="server" Text="43" Visible="true"></asp:Label>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_UserID" HeaderText="用户编号" />
                    <asp:BoundField DataField="F_UserName" HeaderText="用户名称" />
                    <asp:BoundField DataField="TimeCount" HeaderText="在线总时长" />
                    <asp:BoundField DataField="DayNum" HeaderText="天数" />
                    <asp:BoundField DataField="TimeAvg" HeaderText="平均在线时长" />
                </Columns>
                <PagerTemplate>
