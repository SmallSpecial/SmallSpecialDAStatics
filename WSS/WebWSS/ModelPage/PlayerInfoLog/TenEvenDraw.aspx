<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TenEvenDraw.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.TenEvenDraw" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            <div class="itemtitle">
                ...
                >>
                <asp:Label runat="server" Text="十连抽奖信息统计"></asp:Label>
            </div>
            <div class="search">
