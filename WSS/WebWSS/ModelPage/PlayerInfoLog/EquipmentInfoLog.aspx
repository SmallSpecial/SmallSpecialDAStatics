<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentInfoLog.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.EquipmentInfoLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="装备信息统计"></asp:Label>
        </div>
        <div class="search">
                ...
                <asp:Label ID="lblOPID" runat="server" Text="装备"></asp:Label>
                <asp:DropDownList ID="ddlOPID" runat="server">
                    <asp:ListItem Value="50118" Text="装备强化"></asp:ListItem>
                    <asp:ListItem Value="50119" Text="装备升星"></asp:ListItem>
                    <asp:ListItem Value="50120" Text="装备附魔"></asp:ListItem>
                    <asp:ListItem Value="50121" Text="装备宝石"></asp:ListItem>
                    <asp:ListItem Value="50122" Text="装备洗练"></asp:ListItem>
                </asp:DropDownList>
