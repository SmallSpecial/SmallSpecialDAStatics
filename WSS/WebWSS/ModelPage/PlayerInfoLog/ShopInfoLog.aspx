<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopInfoLog.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.ShopInfoLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="商店信息统计"></asp:Label>
        </div>
        <div class="search">
