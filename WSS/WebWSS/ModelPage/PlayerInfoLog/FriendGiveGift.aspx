<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FriendGiveGift.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.FriendGiveGift" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="好友赠送礼物信息统计"></asp:Label>
        </div>
        <div class="search">
     ...
     <asp:Label ID="lblDeType" runat="server" Text="43" Visible="true"></asp:Label>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="SendGiftsTime" HeaderText="日期" />
                    <asp:BoundField DataField="CountNum" HeaderText="次数" />
