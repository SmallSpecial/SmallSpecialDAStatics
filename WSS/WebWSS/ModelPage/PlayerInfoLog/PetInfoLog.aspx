<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PetInfoLog.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.PetInfoLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="宠物信息统计"></asp:Label>
        </div>
        <div class="search">
                ...
                <asp:Label ID="lblOPID" runat="server" Text="宠物"></asp:Label>
                <asp:DropDownList ID="ddlOPID" runat="server">
                    <asp:ListItem Value="0" Text="宠物涨经验"></asp:ListItem>
                    <asp:ListItem Value="3" Text="宠物增加悟性"></asp:ListItem>
                    <asp:ListItem Value="4" Text="宠物增加亲密度"></asp:ListItem>
                    <asp:ListItem Value="8" Text="宠物进化"></asp:ListItem>
                    <asp:ListItem Value="9" Text="宠物资质培养"></asp:ListItem>
                    <asp:ListItem Value="10" Text="宠物资质刷新"></asp:ListItem>
                    <asp:ListItem Value="11" Text="宠物资质保存"></asp:ListItem>
                    <asp:ListItem Value="17" Text="宠物学习技能"></asp:ListItem>
                </asp:DropDownList>
