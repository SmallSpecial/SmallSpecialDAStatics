<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShoppingMallLog.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.ShoppingMallLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="商城信息统计"></asp:Label>
        </div>
        <div class="search">
                ...
                <asp:Label ID="lblPara1" runat="server" Text="道具ID"></asp:Label>
                <asp:TextBox ID="tbPara1" runat="server"></asp:TextBox>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PARA_1" HeaderText="商品ID" />
                    <asp:BoundField DataField="SumNum" HeaderText="卖出数量" />
                    <asp:BoundField DataField="CountNum" HeaderText="卖出次数" />
                </Columns>
