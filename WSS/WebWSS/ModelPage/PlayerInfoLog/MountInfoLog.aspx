<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MountInfoLog.aspx.cs" Inherits="WebWSS.ModelPage.PlayerInfoLog.MountInfoLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="坐骑信息统计"></asp:Label>
        </div>
        <div class="search">
                ...
                <asp:Label ID="lblOPID" runat="server" Text="坐骑"></asp:Label>
                <asp:DropDownList ID="ddlOPID" runat="server">
                    <asp:ListItem Value="0" Text="坐骑激活"></asp:ListItem>
                    <asp:ListItem Value="1" Text="坐骑培养一次"></asp:ListItem>
                    <asp:ListItem Value="2" Text="坐骑培养十次"></asp:ListItem>
                    <asp:ListItem Value="3" Text="坐骑进阶"></asp:ListItem>
                    <asp:ListItem Value="4" Text="坐骑设置"></asp:ListItem>
                </asp:DropDownList>
