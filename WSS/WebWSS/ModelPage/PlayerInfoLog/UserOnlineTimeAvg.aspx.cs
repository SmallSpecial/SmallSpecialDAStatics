...
{
    public partial class UserOnlineTimeAvg : Admin_Page
    {
        #region 属性
        ...
        public void bind()
        {
            ...
            string sql = string.Format("SELECT F_UserID,F_UserName,Sum(F_TimeCount) TimeCount,{0} DayNum,Sum(F_TimeCount)/{1} TimeAvg FROM (", num + 1, num + 1);
