<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeLogin.aspx.cs" Inherits="WebWSS.ModelPage.GameOverView.RealTimeLogin" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="实时登录"></asp:Label>
        </div>
