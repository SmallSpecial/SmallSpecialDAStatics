<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeRemain_Channel.aspx.cs" Inherits="WebWSS.ModelPage.GameOverView.RealTimeRemain_Channel" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="实时留存（渠道）"></asp:Label>
        </div>
