<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeInCome.aspx.cs" Inherits="WebWSS.ModelPage.GameOverView.RealTimeInCome" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="实时收入"></asp:Label>
        </div>
