<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeNew_Zone_Channel.aspx.cs" Inherits="WebWSS.ModelPage.GameOverView.RealTimeNew_Zone_Channel" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="实时新增"></asp:Label>
        </div>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="12pt" Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="30" AllowPaging="true">
                <Columns>
                    <asp:BoundField DataField="ZoneID" HeaderText="区服" />
                    <asp:BoundField DataField="Channel" HeaderText="渠道" />
                    <asp:BoundField DataField="RoleUserNum" HeaderText="创建角色账号数" />
                    <asp:BoundField DataField="RoleDeviceNum" HeaderText="创建角色设备数" />
                    <asp:BoundField DataField="RoleNum" HeaderText="创建角色个数" />
                    <asp:BoundField DataField="RechargeAmount" HeaderText="充值金额" />
                    <asp:BoundField DataField="RechargePeoleOfNum" HeaderText="充值人数" />
                </Columns>
                <PagerTemplate>
