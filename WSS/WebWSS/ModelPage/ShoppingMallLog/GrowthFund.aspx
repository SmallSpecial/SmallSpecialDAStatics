<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrowthFund.aspx.cs" Inherits="WebWSS.ModelPage.ShoppingMallLog.GrowthFund" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="<%$Resources:Language,GrowthFund %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ConsumeNum" HeaderText="<%$Resources:Language,LblMoneyNum %>" />
                    <asp:BoundField DataField="Phases1" HeaderText="<%$Resources:Language,LblPhases1 %>" />
                    <asp:BoundField DataField="Phases2" HeaderText="<%$Resources:Language,LblPhases2 %>" />
                    <asp:BoundField DataField="Phases3" HeaderText="<%$Resources:Language,LblPhases3 %>" />
                    <asp:BoundField DataField="Phases4" HeaderText="<%$Resources:Language,LblPhases4 %>" />
                    <asp:BoundField DataField="Phases5" HeaderText="<%$Resources:Language,LblPhases5 %>" />
                    <asp:BoundField DataField="Phases6" HeaderText="<%$Resources:Language,LblPhases6 %>" />
                    <asp:BoundField DataField="Phases7" HeaderText="<%$Resources:Language,LblPhases7 %>" />
                </Columns>
                <PagerTemplate>
