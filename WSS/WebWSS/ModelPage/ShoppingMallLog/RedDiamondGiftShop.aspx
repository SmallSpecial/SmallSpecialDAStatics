<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedDiamondGiftShop.aspx.cs" Inherits="WebWSS.ModelPage.ShoppingMallLog.RedDiamondGiftShop" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text="<%$Resources:Language,RedDiamondGiftShop %>"></asp:Label>
        </div>
        <div class="search">
            ...
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblProductName %>">
                        ...
                        <ItemTemplate>
                            <%#GetItem(Eval("ProductName").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
