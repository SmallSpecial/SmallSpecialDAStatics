<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CDKeyImport.aspx.cs"
    Inherits="WebWSS.CDKey.CDKeyImport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language='JavaScript' src='../img/Admin.Js'></script>
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:LinkButton ID="LinkButton4" runat="server" Font-Underline="True" Font-Size="13px"
                PostBackUrl="~/cdkey/CDKeyImport.aspx" Enabled="False" Text="<%$Resources:Language,CDK_CDKImport %>"></asp:LinkButton>
        </div>
        <div class="gridv" id="divMain" runat="Server">
                        ...
                        <table class="Text" cellspacing="1" cellpadding="0" width="100%" border="0">
                            <tr height="30">
                                ...
                                <td class="hint">
                                    ...
                                    <font color="red"><asp:Label runat="server"  Text="<%$Resources:Language,CDK_CDKList %>"></asp:Label></font>
            ...
            <asp:GridView ID="GridView1" runat="server" Font-Size="12px" Width="95%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_CDKey" HeaderText="CDKEY" />
