<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldRank_SumRole_Tiqu.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldRank_SumRole_Tiqu" %>
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="GoldSum" HeaderText="提取元宝数"></asp:BoundField>
                        <asp:BoundField DataField="GoldTime" HeaderText="提取次数"></asp:BoundField>
                    </Columns>
