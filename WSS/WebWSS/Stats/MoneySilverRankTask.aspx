<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneySilverRankTask.aspx.cs"
    Inherits="WebWSS.Stats.MoneySilverRankTask" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金币统计>>任务产出排行"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_GoldSum" HeaderText="银币数量" />
                    <asp:BoundField DataField="F_TaskID" HeaderText="<%$Resources:Language,LblTaskNo %>" />
                     <asp:TemplateField HeaderText="<%$Resources:Language,LblTaskName %>" >
                        <ItemTemplate>
                            <%#GetTaskName(Eval("F_TaskID").ToString()) %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_TaskCount" HeaderText="<%$Resources:Language,LblTaskFinshNum %>" />
                </Columns>
