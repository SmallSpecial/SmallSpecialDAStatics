<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserStateActive.aspx.cs" Inherits="WebWSS.Stats.UserStateActive" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblUserActiveStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_FirstLoginNum" HeaderText="<%$Resources:Language,LblNewLoginUser %>" />
                    <asp:BoundField DataField="F_CTNLoginDay2" HeaderText="<%$Resources:Language,LblContinuteLoginTwoDay %>" />
                    <asp:BoundField DataField="F_Remain2" HeaderText="<%$Resources:Language,LblRemainTwoDay %>" />
                    <asp:BoundField DataField="F_CTNLoginDay3" HeaderText="<%$Resources:Language,LblContinuteLoginThreeDay %>" />
                    <asp:BoundField DataField="F_Remain3" HeaderText="<%$Resources:Language,LblRemainThreeDay %>" />
                    <asp:BoundField DataField="F_CTNLoginDay4" HeaderText="<%$ Resources:Language,LblContinuteLoginFourDay %>" />
                    <asp:BoundField DataField="F_CTNLoginDay5" HeaderText="<%$ Resources:Language,LblContinuteLoginFiveDay %>" />
                    <asp:BoundField DataField="F_Remain5" HeaderText="<%$Resources:Language,LblRemainFiveDay %>" />
                    <asp:BoundField DataField="F_CTNLoginDay6" HeaderText="<%$ Resources:Language,LblContinuteLoginSixDay %>" />
                    <asp:BoundField DataField="F_CTNLoginDay7AM" HeaderText="<%$ Resources:Language,LblContinuteLoginSevenDay %>" />
