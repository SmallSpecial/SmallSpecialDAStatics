...
{
    public partial class RoleOnlineLoginRank_Two : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT top 100 ROW_NUMBER() OVER(order by F_TradeCount desc) AS rownum ,F_TradeCount,r.F_UserID,r.F_RoleID,nr.F_RoleName from T_Other_GSLog_Rank  r, T_BaseRoleCreate nr  where F_OPID=40052   and  r.F_RoleID =nr.F_RoleID" + sqlwhere + "";
