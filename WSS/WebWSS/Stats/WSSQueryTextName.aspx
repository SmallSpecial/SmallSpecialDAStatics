<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WSSQueryTextName.aspx.cs" Inherits="WebWSS.Stats.WSSQueryTextName" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 统计系统>>文本查询"></asp:Label>
        </div>
        <div class="search">
            &nbsp; EXCEL编号:<asp:TextBox ID="tboxExcelID" runat="server" Width="80px" MaxLength="10"></asp:TextBox>
            &nbsp; 文本名称:<asp:TextBox ID="tboxTaskName" runat="server" Width="120px" MaxLength="10"></asp:TextBox>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_NameID" HeaderText="文本编号" />
                    <asp:BoundField DataField="F_Name" HeaderText="文本名称" />
                </Columns>
