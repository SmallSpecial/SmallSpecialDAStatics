<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeRoleSumLog.aspx.cs" Inherits="WebWSS.Stats.RechargeRoleSumLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblRechargeRoleSumLog %>"></asp:Label>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_Price" HeaderText="<%$Resources:Language,LblPaySum %>" />
                </Columns>
                <PagerTemplate>
