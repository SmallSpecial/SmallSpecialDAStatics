...
{
    public partial class TaskAcceptRankRT : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT top 100 ROW_NUMBER() OVER(order by F_Num desc) AS rownum, F_Num,F_TaskID, F_TaskName, F_UserID, F_RoleID from T_TaskAcceptRankRT where 1=1 " + sqlwhere + " ";
