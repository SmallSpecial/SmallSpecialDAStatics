<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InTastCount.aspx.cs" Inherits="WebWSS.Stats.InTastCount" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_PARA_1" HeaderText="<%$Resources:Language,LblActiveName %>" />
                    <asp:BoundField DataField="F_LoginCount" HeaderText="<%$Resources:Language,LblLoginerNum %>" />
                    <asp:BoundField DataField="F_InRoleCount" HeaderText="<%$Resources:Language,LblJoinerNum %>" />
                    <asp:BoundField DataField="F_InCount" HeaderText="<%$Resources:Language,LblJoinSum %>" />
                </Columns>
