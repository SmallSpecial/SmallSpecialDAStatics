<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountItem.aspx.cs"
    Inherits="WebWSS.Stats.CountItem" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 推广统计>>操作系统统计"></asp:Label>
        </div>
        <div class="search">
           <%-- 大区:--%>
...
<%--                    <asp:BoundField DataField="日期" HeaderText="日期" >
                    ...
                    <asp:BoundField DataField="item" HeaderText="类型" />
