<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldTypeOut.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldTypeOut" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银币产出"></asp:Label>
        </div>
        <div class="search">
...
<%--                    <asp:BoundField DataField="F_GoldSum0" HeaderText="社交消耗" Visible="false" />
                    ...
                    <asp:BoundField DataField="F_GoldSum7" HeaderText="LGC产出" />
                    <asp:BoundField DataField="F_GoldSum8" HeaderText="GM产出" />
                </Columns>
