<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountTradeAll.aspx.cs" Inherits="WebWSS.Stats.UserAccountTradeAll" %>
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="100" AllowPaging="True" ShowFooter="True">
                    <Columns>
                        <asp:BoundField DataField="F_TradeTime" HeaderText="<%$Resources:Language,LblDate %>"></asp:BoundField>
                        <asp:BoundField DataField="F_TradeMoney" HeaderText="提取钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_Count" HeaderText="提取次数"></asp:BoundField>
                    </Columns>
            ...
            <br />   &nbsp;提示:输入用户编号可查询此用户在一定时间段内的数据(即使不在前100名)
            <br />
        </div>
    </div>
    </form>
