...
{
    public partial class UserStateLose : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT  F_id  ,F_Year,F_Month,F_Day,F_Date,F_BigZone,isnull(F_NoLoginDay3,0) as F_NoLoginDay3,ISNULL(F_NoLoginDay4,0) as F_NoLoginDay4,ISNULL(F_NoLoginDay5,0) as F_NoLoginDay5
,ISNULL(F_NoLoginDay6,0) as F_NoLoginDay6,ISNULL(F_NoLoginDay7AM,0) as F_NoLoginDay7AM FROM T_UserStateLose where F_Date>='" + searchdateB.ToString(DateTimeFormat) + "' and F_Date<='" + searchdateE.ToString(DateTimeFormat) + "' ";
