<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginArea.aspx.cs"
    Inherits="WebWSS.Stats.UserLoginArea" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        ...
        <div class="titletip">
          ...
          <asp:Label runat="server" Text="<%$Resources:Language,LblIpSum %>"></asp:Label>
           <asp:Label ID="lblSum" runat="server" Text=""></asp:Label></h7>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_AreaName" HeaderText="<%$Resources:Language,LblAreaName %>" />
                    <asp:BoundField DataField="F_IPLoginNum" HeaderText="<%$Resources:Language,LblIPNum %>" />
