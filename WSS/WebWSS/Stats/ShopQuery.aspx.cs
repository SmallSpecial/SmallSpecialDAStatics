...
{
    public partial class ShopQuery : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            sqlwhere += @" and (OPID = 40004 or OPID = 40005)";
        ...
        private void InitChatType()
        {
            ...
            string[] ctypes = new string[] { "40004|元宝商城", "40005|绑定元宝商城" };
        ...
        public string GetOPBakFormate(string value)
        {
            try
            {
                ...
                return String.Format("等级:{0} 每份个数:{1} 份数:{2} 是否绑定:{3} 总花费:{4} 是否成功:{5}", items[0], items[2], items[3], items[4], items[5], items[6]);
            }
            catch (System.Exception ex)
            {
                return value;
