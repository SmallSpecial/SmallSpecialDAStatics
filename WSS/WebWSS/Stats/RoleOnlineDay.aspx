<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineDay.aspx.cs" Inherits="WebWSS.Stats.RoleOnlineDay" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:TextBox ID="tboxTimeE" runat="server" Width="120px" MaxLength="10" onFocus="new WdatePicker({skin:'default',startDate:'2011-01-01',isShowClear:false,readOnly:false})"
                class="Wdate" Visible="true"></asp:TextBox>
        ...
        <div class="titletip">
            <h7><div id="DateSelect" runat="Server"></div>
               <asp:Label runat="server" Text="<%$ Resources:Language,LblArea %>"></asp:Label>: <span class="tyellow"><asp:Label ID="LabelArea" runat="server" Text=" "></asp:Label></span>  时间:<span class="tyellow"><asp:Label ID="LabelTime" runat="server" Text=""></asp:Label></span></h7>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblDate %>">
                        <ItemTemplate>
                            <%#Eval("F_Date").ToString().Length > 0 ?  Convert.ToDateTime(Eval("F_Date")).ToString("yyyy-MM-dd") : ""%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_ACU" HeaderText="平均在线人数"  DataFormatString="{0} 人" />
