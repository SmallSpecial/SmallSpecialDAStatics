...
{
    public partial class RechargeByTimeLog : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            sql = @"SELECT COUNT(DISTINCT F_UserID) Num,COUNT(F_TransactionID) F_TransactionID,SUM(F_Price) F_Price FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] WHERE 1=1 AND F_DepositResult=1" + sqlwhere;
        ...
        protected void ExportExcel(object sender, EventArgs e)
        {
            ...
            //sql = @"SELECT F_ID,F_GlobalID,F_UserID,F_TransactionID,F_WebRequestResult,F_ReturnCode,F_ReturnStr,F_ProductID,F_InsertTime,F_StoreName,F_Price,F_DepositResult 
            //FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] " + sqlwhere + " order by F_InsertTime desc";
            sql = @"SELECT COUNT(DISTINCT F_UserID) 人数,COUNT(F_TransactionID) 订单数,SUM(F_Price) 总金额 FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] WHERE 1=1 AND F_DepositResult=1" + sqlwhere;
