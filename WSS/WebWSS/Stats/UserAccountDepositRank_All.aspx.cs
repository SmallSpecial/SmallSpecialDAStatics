...
{
    public partial class UserAccountDepositRank_All : Admin_Page
    {
        ...
        public void bind()
        {
            string sqlStr = @"SELECT top 100 SUM(F_TradeMoney) as F_TradeMoney,SUM(ISNULL(F_GiftMoney,0)) as F_GiftMoney, Count(1) as F_Count,convert(varchar(10),F_TradeTime,112) as F_TradeTime
            ...
            sqlStr += " and F_DESC='充值成功' group by convert(varchar(10),F_TradeTime,112) order by F_TradeTime asc";
