...
{
    public partial class RoleVocationPKHonorRank : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"with RVcte(F_BigZone, F_ZoneID,F_Level, F_PKHonor, F_RoleID, F_Pro, F_RoleName, F_LevelUpTime, F_LastTime)
as
(
SELECT F_BigZone, F_ZoneID,F_Level, F_PKHonor, F_RoleID, F_Pro, F_RoleName, F_LevelUpTime, F_LastTime FROM T_RolePKHonorRank " + sqlwhere + @"

)
select * from (SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc) AS rownum,F_BigZone, F_ZoneID,F_Level, F_PKHonor, F_RoleID, F_Pro, F_RoleName, F_LevelUpTime, F_LastTime
FROM RVcte) a
left join
(SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc) AS rownum1,F_BigZone as F_BigZone1,F_ZoneID as F_ZoneID1,F_Level as F_Level1, F_PKHonor as F_PKHonor1, F_RoleID as F_RoleID1, F_Pro as F_Pro1, F_RoleName as F_RoleName1, F_LevelUpTime as F_LevelUpTime1, F_LastTime as F_LastTime1
FROM RVcte where F_Pro=1)  a1
on a.rownum=a1.rownum1
left join
(SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc) AS rownum2,F_BigZone as F_BigZone2,F_ZoneID as F_ZoneID2,F_Level as F_Level2, F_PKHonor as F_PKHonor2, F_RoleID as F_RoleID2, F_Pro as F_Pro2, F_RoleName as F_RoleName2, F_LevelUpTime as F_LevelUpTime2, F_LastTime as F_LastTime2
FROM RVcte where F_Pro=2)  a2
on a.rownum=a2.rownum2
left join
(SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc) AS rownum3,F_BigZone as F_BigZone3,F_ZoneID as F_ZoneID3,F_Level as F_Level3, F_PKHonor as F_PKHonor3, F_RoleID as F_RoleID3, F_Pro as F_Pro3, F_RoleName as F_RoleName3, F_LevelUpTime as F_LevelUpTime3, F_LastTime as F_LastTime3
FROM RVcte where F_Pro=3)  a3
on a.rownum=a3.rownum3
left join
(SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc) AS rownum4,F_BigZone as F_BigZone4,F_ZoneID as F_ZoneID4,F_Level as F_Level4, F_PKHonor as F_PKHonor4, F_RoleID as F_RoleID4, F_Pro as F_Pro4, F_RoleName as F_RoleName4, F_LevelUpTime as F_LevelUpTime4, F_LastTime as F_LastTime4
FROM RVcte where F_Pro=4)  a4
on a.rownum=a4.rownum4
left join
(SELECT  TOP 50   ROW_NUMBER() OVER(order by F_PKHonor desc,F_LastTime desc) AS rownum99,F_BigZone as F_BigZone99,F_ZoneID as F_ZoneID99,F_Level as F_Level99, F_PKHonor as F_PKHonor99, F_RoleID as F_RoleID99, F_Pro as F_Pro99, F_RoleName as F_RoleName99, F_LevelUpTime as F_LevelUpTime99, F_LastTime as F_LastTime99
FROM RVcte )  a99
