...
{
    public partial class UserStateActive : Admin_Page
    {
...
ISNULL(F_FirstLoginNum,0) as F_FirstLoginNum,ISNULL(F_CTNLoginDay2,0) as F_CTNLoginDay2,ISNULL(F_CTNLoginDay3,0) as F_CTNLoginDay3,
ISNULL(F_CTNLoginDay4,0) as F_CTNLoginDay4,ISNULL(F_CTNLoginDay5,0) as F_CTNLoginDay5,
ISNULL(F_CTNLoginDay6,0) as F_CTNLoginDay6, ISNULL(F_CTNLoginDay7AM,0) as F_CTNLoginDay7AM FROM T_UserStateActive where F_Date>='" + searchdateB.ToString(SmallDateTimeFormat) + "' and F_Date<='" + searchdateE.ToString(SmallDateTimeFormat) + "' ";
            ...
            try
            {
                ...
                for(int i=0;i<dt.Rows.Count;i++)
                {
                    ...
                    {
                        if ((int)dt.Rows[i + 1]["F_FirstLoginNum"] != 0)
                        {
                            double percent = Math.Round((int)dt.Rows[i]["F_CTNLoginDay2"] * 1.00 / (int)dt.Rows[i + 1]["F_FirstLoginNum"] * 100.0, 2);
                    ...
                    {
                        if ((int)dt.Rows[i + 2]["F_FirstLoginNum"] != 0)
                        {
                            double percent1 = Math.Round((int)dt.Rows[i]["F_CTNLoginDay3"] * 1.00 / (int)dt.Rows[i + 2]["F_FirstLoginNum"] * 100.0, 2);
                    ...
                    {
                        if ((int)dt.Rows[i + 4]["F_FirstLoginNum"] != 0)
                        {
                            double percent2 = Math.Round((int)dt.Rows[i]["F_CTNLoginDay5"] * 1.00 / (int)dt.Rows[i + 4]["F_FirstLoginNum"] * 100.0, 2);
                    ...
                    {
                        if ((int)dt.Rows[i + 6]["F_FirstLoginNum"] != 0)
                        {
                            double percent3 = Math.Round((int)dt.Rows[i]["F_CTNLoginDay7AM"] * 1.00 / (int)dt.Rows[i + 6]["F_FirstLoginNum"] * 100.0, 2);
