...
{
    public partial class MoneyLog : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            string sqlCount = "";
            sql = @"SELECT * FROM OPENQUERY ([LKSV_0_GSLOG_DB_" + bigZone + "_" + battleZone + "],'SELECT * FROM " + searchdateB.ToString("yyyy_MM_dd") + "_item_log" + sqlwhere + " limit " + (Convert.ToInt32(lblcurPage.Text) - 1) * 20 + ",20')";
            sqlCount = @"SELECT * FROM OPENQUERY ([LKSV_0_GSLOG_DB_" + bigZone + "_" + battleZone + "],'SELECT * FROM " + searchdateB.ToString("yyyy_MM_dd") + "_item_log" + sqlwhere + "')";
        ...
        protected void ExportExcel(object sender,EventArgs e)
        {
            ...
            string sql = "";
            sql = @"SELECT * FROM OPENQUERY ([LKSV_0_GSLOG_DB_" + bigZone + "_" + battleZone + "],'SELECT UID 用户编号,CID 角色编号,CID 角色名称,PARA_1,PARA_1 PARA_1_,PARA_2,PARA_2 PARA_2_,OPID,OP_BAK,OP_TIME FROM " + searchdateB.ToString("yyyy_MM_dd") + "_item_log')" + sqlwhere;
            ...
            dt.Columns.Add("PARA_1", System.Type.GetType("System.String"));
            dt.Columns.Add("PARA_1_", System.Type.GetType("System.String"));
            dt.Columns.Add("PARA_2", System.Type.GetType("System.String"));
            dt.Columns.Add("PARA_2_", System.Type.GetType("System.String"));
            dt.Columns.Add("OPID", System.Type.GetType("System.String"));
            dt.Columns.Add("OP_BAK", System.Type.GetType("System.String"));
            dt.Columns.Add("OP_TIME", System.Type.GetType("System.String"));
            ...
            if (ds != null)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    dt.Rows.Add(
                        ...
                        GetItem(ds.Tables[0].Rows[i][4].ToString()),
                        ds.Tables[0].Rows[i][5],
                        GetWay(ds.Tables[0].Rows[i][6].ToString()),
                        GetOPID(ds.Tables[0].Rows[i][7].ToString()),
                ...
                if (PageLanguage == "ko-kr")
                {
                    switch(value)
                    {
                        ...
                        case "75":
                            return "길드 혜택";
                        case "76":
                            return "마법 용광로 누적 횟수 보상";
                        case "77":
                            return "마법 용관로 전환 보상";
                        case "78":
                            return "펫 속성 개조 반환 아이템";
                        case "79":
                            return "펫 포획 추가 아이템";
                        case "80":
                            return "DK";
                        ...
                        case "83":
                            return "로그인 보상";
                        case "84":
                            return "전장에서 버프 구매(길드장)";
                        case "85":
                            return "길드전 종료 후 보상 상자 지급";
                        case "86":
                            return "아레나 지급";
                        case "87":
                            return "영지전 획득";
                        ...
                        case "20002":
                            return "탈 것 분해, 탈것 삭제";
                        case "20003":
                            return "탈 것 번식, 아이템 소모";
                        case "20004":
                            return "탈 것 먹이, 아이템 소모";
                        case "20005":
                            return "탈 것 등급 갱신, 아이템 소모";
                        case "20006":
                            return "탈 것 자질 갱신, 아이템 소모";
                        case "20007":
                            return "탈 것 선천 각성, 아이템 소모";
                        case "20008":
                            return "탈 것 후천 각성, 아이템 소모 ";
                        case "20009":
                            return "탈 것 번식 실패, 어린 탈 것 삭제";
                        case "20010":
                            return "法宝升星";
                        case "20011":
                            return "法宝融合";
                        case "20012":
                            return "法宝技能刷新，아이템 소모";
                        case "20013":
                            return "法宝资质提升，아이템 소모";
                        case "20014":
                            return "GM명령 가방 비우기";
                        case "20015":
                            return "GM명령 아이템 삭제";
                        case "20016":
                            return "GM명령 퀘스트 완료, 퀘스트 아이템 삭제 ";
                        case "20017":
                            return "연맹전 참가 신청";
                        case "20018":
                            return "길드 생성, 아이템 소모 ";
                        case "20019":
                            return "오프라인 경험치 수령";
                        case "20020":
                            return "오프라인 이벤트 수익 수령";
                        case "20021":
                            return "호송 마차 승급, 아이템 소모 ";
                        case "20022":
                            return "교환 판매, 아이템 소모 ";
                        case "20023":
                            return "发布金号角，아이템 소모";
                        case "20024":
                            return "发布银号角，아이템 소모";
                        case "20025":
                            return "发布超级宣言，아이템 소모";
                        case "20026":
                            return "생활 스킬 사용, 재료 소모 ";
                        case "20027":
                            return "命魂盒换牌，아이템 소모";
                        case "20028":
                            return "각인 승급，아이템 소모";
                        case "20029":
                            return "맵 전환 길찾기，아이템 소모";
                        case "20030":
                            return "洪荒퀘스트 갱신，아이템 소모";
                        case "20031":
                            return "선물 증정 이벤트，아이템 소모";
                        case "20032":
                            return "장비 제련 (강화)，아이템 소모";
                        case "20033":
                            return "장비 제련 이전, 보조 장비 삭제 ";
                        case "20034":
                            return "장비 装备幻化，아이템 소모";
                        case "20035":
                            return "승급 재료 합성, 승급 재료 삭제";
                        case "20036":
                            return "장비 분해，장비 삭제";
                        case "20037":
                            return "장비 인챈트，아이템 소모";
                        case "20038":
                            return "장비 각인，아이템 소모";
                        case "20039":
                            return "보상 교환，아이템 소모";
                        ...
                        case "20044":
                            return "아이템 사용";
                        case "20045":
                            return "보스 위치로 워프，아이템 소모";
                        case "20046":
                            return "아이템 중첩，아이템 삭제";
                        case "20047":
                            return "아이템 버리기";
                        case "20048":
                            return "줍기 후 슬롯 합침";
                        case "20049":
                            return "이벤트 참가 신청，아이템 소모";
                        case "20050":
                            return "용혼 승급，아이템 소모";
                        case "20051":
                            return "사망 드랍, 아이템 삭제 ";
                        case "20052":
                            return "연신대 입장，아이템 소모";
                        case "20053":
                            return "Npc상점에 사용";
                        case "20054":
                            return "유저 거래";
                        ...
                        case "20068":
                            return "스킬 승급 소모";
                        case "20069":
                            return "灵符注能，승급 재료 소모";
                        case "20070":
                            return "灵符注能，영혼 부적 소모";
                        case "20071":
                            return "사제 아이템 제작 소모";
                        case "20073":
                            return "승급 이전 소모";
                        case "20075":
                            return "탈 것 경험 이전 소모";
                        case "20076":
                            return "보석 정수 승급 재료 소모";
                        case "20077":
                            return "보석 정수 승급 성공 후 삭제";
                        case "20078":
                            return "보석 분해 삭제";
                        case "20079":
                            return "장비 슬롯 재료 삭제";
                        ...
                        case "20086":
                            return "협객 소모 아이템 추가";
                        case "20087":
                            return "협객 레벨 상승 소모 아이템";
                        case "20088":
                            return "협객 경험치 추가 소모 아이템";
                        case "20089":
                            return "협객 장비아이템 소모";
                        case "20090":
                            return "협객 장비 승급 아이템 소모";
                        case "20091":
                            return "합성";
                        case "20092":
                            return "조각 합성";
                        case "20093":
                            return "LongY[Zck] 날개 시스템, 아이템 소모 기록 ";
                        case "20094":
                            return "보석 각인 소모";
                        case "20095":
                            return "보석 승급 소모";
                        ...
                        case "20104":
                            return "부활 삭제";
                        case "20105":
                            return "탈 것 활성화 생성 아이템 삭제";
                        case "20106":
                            return "탈 것 육성 생성 아이템 삭제";
                        case "20107":
                            return "탈 것 육성 생성 아이템 삭제";
                        case "20108":
                            return "성장 아이템 소모";
                        case "20109":
                            return "장비 강화 아이템 소모";
                        case "20110":
                            return "LongY[Zck] 코스튬 시스템, 아이템 소모 기록 ";
                        case "20111":
                            return "장비 인챈트 아이템 소모";
                        case "20112":
                            return "장비 인챈트 육성 아이템 소모";
                        case "20113":
                            return "생활 스킬";
                        case "20114":
                            return "펫 놓아주기";
                        case "20115":
                            return "펫 경험치 상승 아이템 소모";
                        case "20116":
                            return "펫 각성 상승 아이템 소모";
                        case "20117":
                            return "펫 친밀도 상승 아이템 소모";
                        case "20118":
                            return "펫 등급 상승 아이템 소모";
                        case "20119":
                            return "펫 등급 갱신 아이템 소모";
                        case "20120":
                            return "펫 포획 시 포획 아이템 소모";
                        case "20121":
                            return "펫 스킬 학습 아이템 소모";
                        case "20122":
                            return "호송 등급 갱신";
                        default:
                            return value;
                ...
                else
                {
                    ...
                    switch (value)
                    {
                        ...
                        case "83":
                            return "登录奖励";
                        case "84":
                            return "帮战会长购买的，在战场中可以用的增益卷轴（增益BUFF）";
                        case "85":
                            return "帮战结束发放的奖励宝箱";
                        case "86":
                            return "竞技场给的";
                        ...
                        case "20044":
                            return "使用道具";
                        case "20045":
                            return "传送到BOSS所在场景，消耗道具";
                        case "20046":
                            return "道具叠加，删除道具";
                        case "20047":
                            return "丢弃道具";
                        case "20048":
                            return "地上的道具被捡起后从房间删除（仅完全合并时）";
                        case "20049":
                            return "活动报名，消耗道具";
                        case "20050":
                            return "龙魂升阶，消耗道具";
