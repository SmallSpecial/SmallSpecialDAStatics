...
{
    public partial class ShopSaleCount : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"
SELECT TOP 100 F_ID,F_ZoneID,F_UserID,F_RoleID,F_RoleLevel,F_ShopSaleCount,F_MoneyCount
FROM T_ShopSaleCount with(nolock)
where 1=1 AND F_Date>='" + searchdateB.ToString(SmallDateTimeFormat)   + "' and F_Date<='" + searchdateE.ToString(SmallDateTimeFormat)   + "' ";
