<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginHistory.aspx.cs"
    Inherits="WebWSS.Stats.UserLoginHistory" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView2" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_ID" HeaderText="当日平均在线用户" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="最高在线用户" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="最高在线时间" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="最低在线用户" SortExpression="F_ID" />
