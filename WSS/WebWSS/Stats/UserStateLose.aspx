<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserStateLose.aspx.cs" Inherits="WebWSS.Stats.UserStateLose" %>
    ...
    <div class="main">
        <div class="itemtitle">
           <asp:Label ID="LabelTitle" runat="server" Text=" <%$ Resources:Language,LblUserStatis %>"></asp:Label>
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblUserLoseStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_NoLoginDay3" HeaderText="<%$Resources:Language,LblContinuteNoLoginThreeDay %>" />
                    <asp:BoundField DataField="F_NoLoginDay4" HeaderText="<%$Resources:Language,LblContinuteNoLoginFourDay %>" />
                    <asp:BoundField DataField="F_NoLoginDay5" HeaderText="<%$Resources:Language,LblContinuteNoLoginFiveDay %>" />
                    <asp:BoundField DataField="F_NoLoginDay6" HeaderText="<%$Resources:Language,LblContinuteNoLoginSixeDay %>" />
                    <asp:BoundField DataField="F_NoLoginDay7AM" HeaderText="<%$Resources:Language,LblContinuteNoLoginAboveWeek %>" />
                </Columns>
