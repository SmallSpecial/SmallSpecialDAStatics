<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineFlowM_All.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineFlowM_All" %>
    ...
    <div style="margin-left: 5px; margin-top: 0px;">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                AllowPaging="True">
                <Columns>
                    <asp:BoundField DataField="F_CreateTime" HeaderText="<%$Resources:Language,LblTimeWithUnit %>" />
                    <asp:BoundField DataField="F_PlayerNumOnline" HeaderText="<%$Resources:Language,LblOnlinePopulation %>" />
                </Columns>
