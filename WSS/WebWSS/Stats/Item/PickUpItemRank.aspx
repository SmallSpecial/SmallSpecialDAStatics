<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickUpItemRank.aspx.cs" Inherits="WebWSS.Stats.Item.PickUpItemRank" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="拾取个数" DataField="F_TradeCount" DataFormatString="{0}个" />
                </Columns>
