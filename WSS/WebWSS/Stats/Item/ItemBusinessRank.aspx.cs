...
{
    public partial class ItemBusinessRank : BasePage
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT  top 100 ROW_NUMBER() OVER(order by F_TradeCount desc) AS rownum, F_BigZone,F_ZoneID,F_ExcelID,F_TradeCount FROM T_ItemBusiness_Rank with(nolock) where 1=1 " + sqlwhere + " ";
