<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemBusinessRank.aspx.cs"
    Inherits="WebWSS.Stats.Item.ItemBusinessRank" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 道具>>物品统计》道具被交易次数排行"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="物品编号" DataField="F_ExcelID" />
