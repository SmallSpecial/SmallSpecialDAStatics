...
{
    public partial class RoleRank_Trade_InCount : BasePage
    {
        ...
        public void bind()
        {
            ...
            sqlwhere += " and F_OPID=" + Request.QueryString["opid"] + " and F_PARA_2=" + Request.QueryString["p2"];

            string sql = "";
            sql = @"SELECT TOP 100 F_BigZone,F_ZoneID,F_UserID,F_RoleID,F_TradeCount,F_MoneyCount FROM T_Item_GSLog_Rank with(nolock) WHERE 1=1 " + sqlwhere + " order by F_TradeCount desc";
