<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeTotal.aspx.cs" Inherits="WebWSS.Stats.Item.TypeTotal" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="数量" DataField="F_MoneyCount" DataFormatString="{0}个" />
                </Columns>
