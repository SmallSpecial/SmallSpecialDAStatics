<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineHour.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineHour" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
                ...
                <asp:Label ID="LabelTitle" runat="server" Text=" <%$ Resources:Language,LblOnlineStatic %>"></asp:Label>>>玩家在线统计
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblTime %>">
                        <ItemTemplate>
                            <%#Eval("F_Hour").ToString().Length > 0 ?  Eval("F_Hour").ToString() + '点' : ""%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_OnlineNum" HeaderText="历史人数" />
                    <asp:BoundField DataField="F_OnlineNumACU" HeaderText="平均在线人数" Visible="False" />
                    <asp:BoundField DataField="F_OnlineIpNum" HeaderText="历史IP" />
                    <asp:BoundField DataField="F_LoginNum" HeaderText="<%$Resources:Language,LblLoginNumber %>" />
                    <asp:BoundField DataField="F_LoginIpNum" HeaderText="<%$Resources:Language,LblLoginIp %>" />
                    <asp:BoundField DataField="F_ExitNum" HeaderText="退出次数" />
                    <asp:BoundField DataField="F_ExitIpNum" HeaderText="退出IP" />
                    <asp:BoundField DataField="F_OnlineTime" HeaderText="在线时长(分钟)" />
