<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HonorMoneySRoleRank.aspx.cs"
    Inherits="WebWSS.Stats.HonorMoneySRoleRank" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="财富榜>>角色银币排行"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <span class="checkBox">
                <asp:CheckBox ID="ckDescoding" Text="解码" runat="server" />
            </span>
        ...
        <div class="titletip">
            ...
            <asp:Label ID="lblEncoding" runat="server" Text="<%$Resources:Language,LblCodeOpen %>" Visible="false"></asp:Label>
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        <asp:BoundField DataField="RankNumber" HeaderText="<%$Resources:Language,LblRank %>" DataFormatString="第 {0} 名">
                            <ItemStyle Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ObjectID" HeaderText="<%$Resources:Language,LblRoleNo %>">
                            <ItemStyle Width="100px" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="角色名称">
                            <ItemStyle Width="260px" />
                            <ItemTemplate>
                                <%#TransDe(Eval("ObjectName").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="职业">
                            <ItemStyle Width="150px" />
                            <ItemTemplate>
                                <%#GetVacationTypeName(Eval("ObjectIntInfo").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="SortValue" HeaderText="银币数量" DataFormatString="{0:#,#0}">
