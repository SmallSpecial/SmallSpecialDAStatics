...
{
    public partial class TaskQuery : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            if (tboxContent.Text.Trim().Length > 0)
            {
                ...
                sqlwhere += @" and OP_BAK like ''%" + tboxContent.Text.Replace("'", "") + "%''";
            }
        ...
        private void InitChatType()
        {
            ...
            string[] ctypes = new string[] { "10027|接受任务", "10028|完成任务", "10030|放弃任务", "10058|接受悬赏任务", "10059|完成悬赏任务", "10060|删除悬赏任务", "10061|放弃悬赏任务", "10062|直接完成悬赏任务", "10063|刷新悬赏任务星级" };
        ...
        public string GetTType(string cid)
        {
            string back ="";
            switch (cid)
            {
