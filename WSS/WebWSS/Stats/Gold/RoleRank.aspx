<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRank.aspx.cs" Inherits="WebWSS.Stats.Gold.RoleRank" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城>>元宝统计"></asp:Label>
                ...
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language,LblRoleNo %>">
                            ...
                            <ItemTemplate>
                                <%#GetRoleName(DropDownListArea1.SelectedValue.Split(',')[1], Eval("F_RoleID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="F_GoldCount" HeaderText="提取元宝数"></asp:BoundField>
                        <asp:BoundField DataField="F_PickUpCount" HeaderText="提取次数"></asp:BoundField>
                    </Columns>
