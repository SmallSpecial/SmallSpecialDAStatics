...
{
    public partial class ItemQuery : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            if (ddlPara2Type.SelectedIndex > 0)
            {
                sqlwhere += @" and PARA_2 = " + ddlPara2Type.SelectedValue + "";
            }
        ...
        public string GetOPBakFormate(string value)
        {
            try
            {
                ...
                return String.Format("数量:{0} GUID:{1} 叠加:{2} 场景ID:{3}", items[0], items[1], items[2], items[3]);
