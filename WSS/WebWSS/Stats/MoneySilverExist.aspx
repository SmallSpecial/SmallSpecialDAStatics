<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneySilverExist.aspx.cs"
    Inherits="WebWSS.Stats.MoneySilverExist" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银币存有量"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_Money" HeaderText="银币存有量" />
                </Columns>
