<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneySilverOutIn.aspx.cs"
    Inherits="WebWSS.Stats.MoneySilverOutIn" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="产出" HeaderText="银币产出" />
                    <asp:BoundField DataField="消耗" HeaderText="银币消耗" />
                    <asp:BoundField DataField="结余" HeaderText="银币结余" />
                </Columns>
