<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountLogQuery.aspx.cs" Inherits="WebWSS.Stats.UserAccountLogQuery" %>
...
统计系统>>充值记录查询 
        ...
        <div class="search">
            ...
            &nbsp; 充值结果:<asp:DropDownList ID="ddlResult" runat="server">
                <asp:ListItem Text="<%$Resources:Language,LblAllSelect %>"></asp:ListItem>
                <asp:ListItem>充值成功</asp:ListItem>
                <asp:ListItem>充值失败</asp:ListItem>
            </asp:DropDownList>
            &nbsp; 排序方式:
            <asp:RadioButton ID="rbtTradID" runat="server" Checked="True" Text="充值时间" 
                GroupName="GPOder" /><asp:RadioButton ID="rbtTradeMoney" runat="server" Text="充值钱数" GroupName="GPOder" />
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        <asp:BoundField DataField="F_TradID" HeaderText="充值编号"></asp:BoundField>
                        <asp:BoundField DataField="F_OrderNO" HeaderText="支付编号"></asp:BoundField>
                        <asp:BoundField DataField="F_UserID" HeaderText="<%$Resources:Language,LblUserNo %>"></asp:BoundField>
                        <asp:BoundField DataField="F_PreMoney" HeaderText="之前钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_TradeMoney" HeaderText="充值钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_AfterMoney" HeaderText="之后钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_TradeTime" HeaderText="充值时间"></asp:BoundField>
                        <asp:BoundField DataField="F_Desc" HeaderText="充值结果"></asp:BoundField>
                    </Columns>
