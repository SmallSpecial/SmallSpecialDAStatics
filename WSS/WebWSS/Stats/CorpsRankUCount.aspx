<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpsRankUCount.aspx.cs"
    Inherits="WebWSS.Stats.CorpsRankUCount" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 角色统计>>帮会人数排行"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv" style="margin-right: 100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_UserCount" HeaderText="帮会人数" />
