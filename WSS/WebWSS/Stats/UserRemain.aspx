<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRemain.aspx.cs" Inherits="WebWSS.Stats.UserRemain" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblUserRemain %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LoginDay30Num" HeaderText="D_30" />
                </Columns>
