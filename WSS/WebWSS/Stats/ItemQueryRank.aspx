<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemQueryRank.aspx.cs"
    Inherits="WebWSS.Stats.ItemQueryRank" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblEventType %>"></asp:Label>:<asp:DropDownList ID="ddlOPID" runat="server">
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="RCOUNT" HeaderText="<%$Resources:Language,LblFrequency %>"></asp:BoundField>
                    </Columns>
