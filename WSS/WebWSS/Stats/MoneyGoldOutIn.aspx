<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldOutIn.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldOutIn" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银币产出消耗"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                   ...
                   <%-- <asp:BoundField DataField="F_ZoneID" HeaderText="战区" />--%>
                    <asp:BoundField DataField="产出" HeaderText="金币产出" />
                    <asp:BoundField DataField="消耗" HeaderText="金币消耗" />
                    <asp:BoundField DataField="结余" HeaderText="金币结余" />
                </Columns>
