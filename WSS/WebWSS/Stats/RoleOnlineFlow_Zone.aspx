<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineFlow_Zone.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineFlow_Zone" %>
    ...
    <div style="margin-left: 5px; margin-top: 0px;">
        <div>
            ...
            <asp:DropDownList ID="DropDownListArea1" runat="server" Width="120" AutoPostBack="false"
                ...
                <asp:ListItem Text="<%$Resources:Language,LblAllBigZone%>">
                </asp:ListItem>
            </asp:DropDownList>
            ...
            &nbsp; <asp:Literal runat="server" Text="<%$ Resources:Language,LblStaticTime %>"></asp:Literal>:<asp:TextBox ID="tboxTimeB" runat="server" Width="80px" MaxLength="10"></asp:TextBox>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                AllowPaging="True">
                <Columns>
                    <asp:BoundField DataField="F_Time" HeaderText="<%$Resources:Language,LblTime %>" DataFormatString="{0}<%$Resources:Language,LblHourUnit %>" />
                </Columns>
