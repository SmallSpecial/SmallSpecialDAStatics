<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatRoleNumRank.aspx.cs"
    Inherits="WebWSS.Stats.ChatRoleNumRank" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblRoleChatNumRank %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_Num" HeaderText="<%$Resources:Language,LblChatNum %>" />
