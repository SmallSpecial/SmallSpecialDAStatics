<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicSale.aspx.cs" Inherits="WebWSS.Stats.PublicSale" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 拍卖行统计>>整体统计"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_DateT" HeaderText="<%$Resources:Language,LblDate %>" />
                    <asp:BoundField DataField="F_Num" HeaderText="拍卖数量" />
                    <asp:BoundField DataField="F_ItemNum" HeaderText="道具数量" />
           <%--         <asp:BoundField DataField="F_Money" HeaderText="金钱数量" />--%>
                    <asp:BoundField DataField="F_Num1" HeaderText="拍卖数量(金)" />
                    <asp:BoundField DataField="F_ItemNum1" HeaderText="道具数量(金)" />
                    <asp:BoundField DataField="F_Money1" HeaderText="金钱数量(金)" />
                    <asp:BoundField DataField="F_Num0" HeaderText="拍卖数量(银)" />
                    <asp:BoundField DataField="F_ItemNum0" HeaderText="道具数量(银)" />
                    <asp:BoundField DataField="F_Money0" HeaderText="金钱数量(银)" />
                </Columns>
