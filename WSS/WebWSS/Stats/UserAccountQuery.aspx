<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountQuery.aspx.cs" Inherits="WebWSS.Stats.UserAccountQuery" %>
...
统计系统>>帐户查询 
        ...
        <div class="search">
            ...
            &nbsp; 排序方式:
            <asp:RadioButton ID="rbtUserID" runat="server" Checked="True" Text="<%$Resources:Language,LblUserNo %>" 
                GroupName="GPOder" /><asp:RadioButton ID="rbtRealMoney" runat="server" Text="真钱数量" GroupName="GPOder" />
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_RealMoney" HeaderText="真钱数量"></asp:BoundField>
                        <asp:BoundField DataField="F_BindMoney" HeaderText="绑定钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_ThiredMoney" HeaderText="第三方钱数"></asp:BoundField>
                    </Columns>
