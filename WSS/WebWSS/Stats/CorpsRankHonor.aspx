<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpsRankHonor.aspx.cs"
    Inherits="WebWSS.Stats.CorpsRankHonor" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblCorpsRankHonorStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv" style="margin-right: 100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="rownum" HeaderText="<%$Resources:Language, LblRank%>" DataFormatString="<%$Resources:Language, Msg_RankFormat%>">
                        <ItemStyle Width="120px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="rownum" HeaderText="<%$Resources:Language,LblCorpsNo %>">
                        <ItemStyle Width="80px" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblCorpsName %>">
                        <ItemTemplate>
                            <%#TransDe(Eval("F_CorpsName").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_CorpsLevel" HeaderText="<%$Resources:Language,LblCorpsLevel %>" />
                    <asp:BoundField DataField="F_CorpsHonor" HeaderText="<%$Resources:Language,LblCorpsHonor %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblCorpsLeader %>">
                        <ItemTemplate>
                            <%#TransDe(Eval("F_OrgCreaterName").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblFounder %>">
                        <ItemTemplate>
                            <%#TransDe(Eval("F_CreaterName").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_CurMoney" HeaderText="<%$Resources:Language,LblMoney %>" />
                    <asp:BoundField DataField="F_CurExp" HeaderText="<%$Resources:Language,LblExp %>" />
                </Columns>
            ...
            <div style="display: none">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="rownum" HeaderText="<%$Resources:Language,LblLevel %>" DataFormatString="<%$Resources:Language,Msg_RankFormat %>"></asp:BoundField>
