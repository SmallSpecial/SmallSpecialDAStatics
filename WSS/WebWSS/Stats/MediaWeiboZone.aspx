<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaWeiboZone.aspx.cs"
    Inherits="WebWSS.Stats.MediaWeiboZone" %>
    ...
    <table class="TD1" border="0" cellspacing="1" cellpadding="3" width="100%">
        <tbody>
            <tr class="itemtitle" style="height: 30px;">
                <td>
                    <asp:Label ID="LabelTitle" runat="server" Text="推广统计>>微博统计"></asp:Label>
                </td>
            </tr>
        </tbody>
    </table>
    <div style="margin-left: 5px; margin-top: 0px;">
        <div>
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <%--服务器:--%><asp:DropDownList ID="DropDownListArea2" runat="server" Width="120" Visible="False">
                 <asp:ListItem Text="<%$ Resources:Language,LblAllZone %>"></asp:ListItem>
            </asp:DropDownList>

            &nbsp; <asp:Label runat="server" Text="<%$ Resources:Language,LblStaticTime %>"></asp:Label>:<asp:TextBox ID="tboxTimeB" runat="server" Width="80px" MaxLength="10"></asp:TextBox><a style='cursor: pointer;' onclick='PopCalendar.show(document.getElementById("tboxTimeB"), "yyyy-mm-dd", null, null, null, "11");'>
            ...
            <asp:TextBox ID="tboxTimeE" runat="server" Width="120px" MaxLength="10" onFocus="new WdatePicker({skin:'default',startDate:'2011-01-01',isShowClear:false,readOnly:false})"
                class="Wdate"></asp:TextBox><a style='cursor: pointer;' onclick='PopCalendar.show(document.getElementById("tboxTimeE"), "yyyy-mm-dd", null, null, null, "11");'>
                <img src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'></a>
