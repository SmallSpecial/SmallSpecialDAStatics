...
{
    public partial class CorpsRankUCount : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT ROW_NUMBER() OVER(order by F_UserCount desc) AS rownum, F_Year, F_Month, F_Day, F_Date, F_BigZone, F_ZoneID, F_CorpsHonor, F_CorpsID, F_CorpsName, F_CorpsLevel, F_OrgCreaterName, F_CreaterName, F_CreaterPro, F_CurMoney, F_CurExp, F_CreateTime, F_LastUpDataTime,F_UserCount FROM T_CorpsRankUCount " + sqlwhere + "";
