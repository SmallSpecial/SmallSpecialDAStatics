...
{
    public partial class RechargeRoleSumLog : Admin_Page
    {
...
//FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] " + sqlwhere + " order by F_InsertTime desc";
            sql = @"SELECT F_GlobalID,F_UserID,SUM(F_Price) F_Price FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] WHERE 1=1 AND F_DepositResult=1" + sqlwhere +"GROUP BY F_GlobalID,F_UserID";
        ...
        protected void ExportExcel(object sender,EventArgs e)
        {
            ...
            //sql = @"SELECT F_ID,F_GlobalID,F_UserID,F_TransactionID,F_WebRequestResult,F_ReturnCode,F_ReturnStr,F_ProductID,F_InsertTime,F_StoreName,F_Price,F_DepositResult 
//FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] " + sqlwhere + " order by F_InsertTime desc";
            sql = @"SELECT F_GlobalID 角色编号,F_UserID 用户编号,SUM(F_Price) 充值钱总数 FROM [LKSV_5_UserCoreDB_0_1].[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] WHERE 1=1 AND F_DepositResult=1" + sqlwhere +"GROUP BY F_GlobalID,F_UserID";
