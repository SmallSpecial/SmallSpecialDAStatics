...
{
    public partial class MoneyGoldOutIn : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT convert(varchar(10),F_Date,120) as 日期,F_ZoneID, F_GoldSurplus as 结余, F_GoldOut as 产出, F_GoldIn as 消耗 FROM T_MoneyGold where F_Date>='" + searchdateB.ToString(SmallDateTimeFormat) + "' and F_Date<='" + searchdateE.ToString(SmallDateTimeFormat) + "' ";
