<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLoseTimeFirst.aspx.cs"
    Inherits="WebWSS.Stats.RoleLoseTimeFirst" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblOnlineTimeLoseStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                ShowFooter="True">
                <Columns>
                 <%--   <asp:BoundField DataField="时间" HeaderText="时间" DataFormatString="{0} 分钟" />
                    <asp:BoundField DataField="猎魔者" HeaderText="猎魔者" />
                    <asp:BoundField DataField="魔导师" HeaderText="魔导师" />
                    <asp:BoundField DataField="龙战士" HeaderText="龙战士" />
                    <asp:BoundField DataField="召唤师" HeaderText="召唤师" />--%>
            ...
            <asp:Label ID="lblerro" runat="server" Text="<%$Resources:Language,Tip_Nodata %>" ForeColor="#FF6600"></asp:Label>
             <span style="display:none" >
                <asp:Label Text="<%$Resources:Language,Tip_Sign %>" runat="server"></asp:Label> 
                <asp:Label ID="lblinfo" runat="server" Text="" ForeColor="#FF6600"></asp:Label></span>
