<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginZone.aspx.cs"
    Inherits="WebWSS.Stats.UserLoginZone" %>
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" <%$ Resources:Language,LblUserStatis %>"></asp:Label>>>
             <asp:Label ID="Label1" runat="server" Text=" <%$ Resources:Language,LblUserLoginStatis %>"></asp:Label>
        </div>
        <div class="search">
              <asp:Label runat="server" Text="<%$ Resources:Language,LblAllBigZone %>"></asp:Label>:
            ...
            -<asp:TextBox ID="tboxTimeE" runat="server" Width="80px" MaxLength="10"></asp:TextBox><a
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="80" AllowPaging="True"
                ShowFooter="True">
                <Columns>
                    <asp:BoundField DataField="F_Date" HeaderText="<%$Resources:Language,LblTime %>" DataFormatString="{0:d}" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblZone %>" >
                        <ItemTemplate>
                            <asp:Label runat="server" ><%# (!string.IsNullOrEmpty(Eval("F_ZoneID").ToString())? FormatZoneName(Eval("F_ZoneID").ToString()):string.Empty) %></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_UserLoginNum" HeaderText="<%$Resources:Language,LblUserLoginSum %>" />
                    <asp:BoundField DataField="F_IPLoginNum" HeaderText="<%$Resources:Language,LblIpSum %>" />
                    <asp:BoundField DataField="F_UserLoginDay2" HeaderText="<%$Resources:Language,LblContinueLoginAboveTwoDaySum %>" />
                    <asp:BoundField DataField="F_UserLoginDay3" HeaderText="<%$Resources:Language,LblContinueLoginAboveThreedDaySum %>" />
                    <asp:BoundField DataField="F_UserFirstLoginNum" HeaderText="<%$Resources:Language,LblNewLoginUser %>" />
                    <asp:BoundField DataField="F_UserNoLoginDay3" HeaderText="<%$Resources:Language,LblContinueThreedDaySumNoLogin %>" />
                    <asp:BoundField DataField="F_UserNoLoginDay3M" HeaderText="<%$Resources:Language,LblAboveThreeDayNoLogin %>" />
                    <asp:BoundField DataField="F_UserNoLoginDay7" HeaderText="<%$Resources:Language,LblWeekNoLoginOfUser %>" />
                    <asp:BoundField DataField="F_UserNoLoginDay7M" HeaderText="<%$Resources:Language,LblAboveWeekNoLoginOfUser %>" />
                </Columns>
