<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatRoleRpeatRank.aspx.cs"
    Inherits="WebWSS.Stats.ChatRoleRpeatRank" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="25" ShowFooter="false" onrowcommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblChatDetail %>">
                        <ItemTemplate>
                            <%#TransDe(Eval("F_Content").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Num" HeaderText="<%$Resources:Language,LblRepeactNum %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblOperate %>">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButtonDetail" runat="server" CommandArgument ="<%# GridView1.Rows.Count %>" CommandName="Detail" Text="<%$Resources:Language,LblViewChatDetail %>"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
