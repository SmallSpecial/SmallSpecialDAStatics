<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldType.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldType" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
                ...
                <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银币消耗"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; <asp:Literal runat="server" Text="<%$ Resources:Language,LblStaticTime %>"></asp:Literal>:<asp:TextBox ID="tboxTimeB" runat="server" Width="80px" MaxLength="10"></asp:TextBox><a style='cursor: pointer;' onclick='PopCalendar.show(document.getElementById("tboxTimeB"), "yyyy-mm-dd", null, null, null, "11");'><img src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'></a>
            <asp:Literal runat="server" Text="<%$ Resources:Language,LblEndTime %>"></asp:Literal>:<asp:TextBox ID="tboxTimeE" runat="server" Width="80px" MaxLength="10" ></asp:TextBox><a style='cursor: pointer;' onclick='PopCalendar.show(document.getElementById("tboxTimeE"), "yyyy-mm-dd", null, null, null, "11");'><img src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'></a>
            ...
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="日期" HeaderText="<%$Resources:Language,LblDate %>" />
                     <asp:TemplateField  HeaderText="战区">
                        <ItemTemplate>
                            <%#FormatZoneName(Eval("F_zoneId").ToString()) %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_GoldSum0" HeaderText="社交消耗" />
                    <asp:BoundField DataField="F_GoldSum1" HeaderText="NPC消耗" />
                    <asp:BoundField DataField="F_GoldSum2" HeaderText="装备改造消耗" />
                    <asp:BoundField DataField="F_GoldSum3" HeaderText="任务消耗" />
<%--                    <asp:BoundField DataField="F_GoldSum4" HeaderText="任务产出"   Visible =false />
                    <asp:BoundField DataField="F_GoldSum5" HeaderText="NPC产出"  Visible =false />
                    <asp:BoundField DataField="F_GoldSum6" HeaderText="发奖产出"  Visible =false />--%>
                </Columns>
