<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountInterzone.aspx.cs"
    Inherits="WebWSS.Stats.UserAccountInterzone" %>
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        <asp:BoundField DataField="AccountInterzone" HeaderText="区间(人民币)"></asp:BoundField>
                        <asp:BoundField DataField="UserCount" HeaderText="账号数"></asp:BoundField>
                        <asp:BoundField HeaderText="人数百分比"></asp:BoundField>
                    </Columns>
