<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserStateBack.aspx.cs" Inherits="WebWSS.Stats.UserStateBack" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblUserStateBackStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_BackIntervalDay3" HeaderText="<%$Resources:Language,LblBackAfterThreeDay %>" />
                    <asp:BoundField DataField="F_BackIntervalDay4" HeaderText="<%$Resources:Language,LblBackAfterFourDay %>" />
                    <asp:BoundField DataField="F_BackIntervalDay5" HeaderText="<%$Resources:Language,LblBackAfterFiveDay %>" />
                    <asp:BoundField DataField="F_BackIntervalDay6" HeaderText="<%$Resources:Language,LblBackAfterSixDay %>" />
                    <asp:BoundField DataField="F_BackIntervalDay7AM" HeaderText="<%$Resources:Language,LblBackAfterWeekOrAbove %>" />
                </Columns>
