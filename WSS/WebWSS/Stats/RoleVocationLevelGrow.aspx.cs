...
{
    public partial class RoleVocationLevelGrow : Admin_Page
    {
...
as
(
SELECT F_Level,F_VocationType, Sum(F_VocationNum) as F_VocationNum FROM T_RoleLevelGrow " + sqlwhere + @"
...
{0}
 FROM RVcte a order by a.F_Level asc";
            ...
            try
            {
                ...
                columnValue = new List<long>();//这里可以进行一优化处理
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                lblinfo.Text =App_GlobalResources.Language.LblError + ex.Message;
