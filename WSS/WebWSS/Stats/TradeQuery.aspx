<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradeQuery.aspx.cs" Inherits="WebWSS.Stats.TradeQuery" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="道具统计>>交易日志查询"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblEventType %>"></asp:Label>:<asp:DropDownList ID="ddlGoldType" runat="server">
                ...
                <asp:ListItem Value="10002">道具交易</asp:ListItem>
                <asp:ListItem Value="10070">金钱交易</asp:ListItem>
            </asp:DropDownList>
            ...
            &nbsp; 帐户A编号:<asp:TextBox ID="tboxUID" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            &nbsp; 角色A编号:<asp:TextBox ID="tboxCID" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            &nbsp; 帐户B编号:<asp:TextBox ID="tboxPARA_1" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            &nbsp; 角色B编号:<asp:TextBox ID="tboxPARA_2" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="帐户A编号">
                            <ItemStyle Width="80px" />
                            <ItemTemplate>
                                <%#Eval("UID")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="角色A编号">
                            <ItemStyle Width="130px" />
                            <ItemTemplate>
                                <%#GetRoleName(DropDownListArea1.SelectedValue.Split(',')[1],Eval("CID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="事件类型*"  SortExpression="OPID" >
                            <ItemStyle Width="100px" />
                            <ItemTemplate>
                                <%#GetTypeName(ddlGoldType, Eval("OPID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="帐户B编号">
                            <ItemStyle Width="80px" />
                            <ItemTemplate>
                                <%#Eval("PARA_1")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="角色B编号">
                            <ItemStyle Width="130px" />
                            <ItemTemplate>
                                <%#GetRoleName(DropDownListArea1.SelectedValue.Split(',')[1], Eval("PARA_2").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
