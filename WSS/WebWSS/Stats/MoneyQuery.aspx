<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyQuery.aspx.cs" Inherits="WebWSS.Stats.MoneyQuery" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="金钱统计>>金钱日志查询"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblEventType %>"></asp:Label>:<asp:DropDownList ID="ddlOPID" runat="server" AutoPostBack="True" 
                onselectedindexchanged="ddlOPID_SelectedIndexChanged">
                <asp:ListItem Text="<%$Resources:Language,LblAllSelect %>"></asp:ListItem>
                <asp:ListItem Value="10037">银币的产生和消耗</asp:ListItem>
                <asp:ListItem Value="10038">银票的产生和消耗</asp:ListItem>
            </asp:DropDownList>
                ...
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField     HeaderText="<%$Resources:Language,LblEventType %>" >
                            <ItemStyle Width="100px" />
                            <ItemTemplate>
                                <%#GetTypeName(ddlOPID, Eval("OPID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="PARA_2" HeaderText="金钱变化值">
                            <ItemStyle Width="80px" />
                        </asp:BoundField>
