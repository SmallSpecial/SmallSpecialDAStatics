...
{
    public partial class UserRemain : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT * FROM T_UserRemain where F_Date>='" + searchdateB.ToString(SmallDateTimeFormat) + "' and F_Date<='" + searchdateE.ToString(SmallDateTimeFormat) + "' ";
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        if (((int)dt.Rows[i + 1]["F_LoginDay1Num"] != 0))
                        {
                    ...
                    {
                        if ((int)dt.Rows[i + 2]["F_LoginDay1Num"] != 0)
                        {
                    ...
                    {
                        if ((int)dt.Rows[i + 4]["F_LoginDay1Num"] != 0)
                        {
                    ...
                    {
                        if ((int)dt.Rows[i + 6]["F_LoginDay1Num"] != 0)
                        {
