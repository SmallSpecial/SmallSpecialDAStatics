<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskAcceptFinish.aspx.cs"
    Inherits="WebWSS.Stats.TaskAcceptFinish" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblTaskFinshProportion %>"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:TextBox ID="tboxTimeE" runat="server" Width="120px" MaxLength="10" onFocus="new WdatePicker({skin:'default',startDate:'2011-01-01',isShowClear:false,readOnly:false})"
                class="Wdate" Visible="true"></asp:TextBox><a style='cursor: pointer;' onclick='PopCalendar.show(document.getElementById("tboxTimeE"), "yyyy-mm-dd", null, null, null, "11");'><img
                    src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'></a>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                AutoGenerateColumns="False" Font-Size="12px" Width="95%" OnSorting="GridView1_Sorting" AllowSorting="true"
                CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White" BorderColor="#CCCCCC"
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="1000" AllowPaging=true>
                <Columns>
                    ...
                    <asp:BoundField DataField="F_NumFinish" HeaderText="<%$Resources:Language,LblTaskFinshNum %>" />
                    <asp:BoundField DataField="F_NumAccept" HeaderText="<%$Resources:Language,LblTaskAcceptNum %>" />
                    <asp:BoundField DataField="F_AC" HeaderText="<%$Resources:Language,LblTaskAccept_FinshProportion %>" DataFormatString="{0:0.00%}" SortExpression="F_AC"/>
                </Columns>
