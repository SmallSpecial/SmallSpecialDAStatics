<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleB_Day.aspx.cs" Inherits="WebWSS.Stats.ShopSaleB_Day" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                <asp:BoundField DataField="F_Date" HeaderText="日 期" DataFormatString="{0:yyyy-MM-dd}" />
