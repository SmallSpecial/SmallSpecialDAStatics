<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountInterzoneShopSaleItems.aspx.cs"
    Inherits="WebWSS.Stats.AccountInterzoneShopSaleItems" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城统计>>玩家消费习惯统计"></asp:Label>
        </div>
        <div class="search">
