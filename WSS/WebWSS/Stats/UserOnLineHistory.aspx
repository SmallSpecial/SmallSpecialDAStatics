<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOnLineHistory.aspx.cs" Inherits="WebWSS.Stats.UserOnLineHistory" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        ...
        <div class="search">
            功能选择:
            <asp:DropDownList ID="DropDownListNavi" runat="server" Width="120" 
                AutoPostBack="True" 
            ...
            <asp:DropDownList ID="DropDownListArea3" runat="server" Width="120" 
                Visible="False">
                <asp:ListItem Text="<%$ Resources:Language,LblAllZoneLine %>"></asp:ListItem>
            </asp:DropDownList>
            &nbsp;
                <asp:Label ID="LabelSTime"
                runat="server" Text="时间选择:"></asp:Label>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView2" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                BorderColor="#CCCCCC" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="25" Visible="False">
                <Columns>
                    <asp:BoundField DataField="F_ID" HeaderText="服务器名称" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="服务器在线" SortExpression="F_ID" />
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                PageSize="25">
                <Columns>
                <asp:BoundField DataField="F_ID" HeaderText="<%$Resources:Language,LblDate %>" SortExpression="F_ID"  DataFormatString="2012-3-{0}" />
        ...
        DataTextField="F_ID" HeaderText="服务器名称" SortExpression="F_ID"  DataTextFormatString="服务器{0}">
<%--                    <ItemStyle CssClass="action" Width="10%" />
                    ...
                    <asp:BoundField DataField="F_ID" HeaderText="服务器在线" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="IP数量" SortExpression="F_ID" />
                    <asp:BoundField DataField="F_ID" HeaderText="IP数量比" SortExpression="F_ID" DataFormatString="{0}%"/>
                    <asp:BoundField HeaderText="图XX（备用）" />
                </Columns>
                <SelectedRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#006699" Font-Size="12px" HorizontalAlign="Center" Font-Bold="True"
