<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineLoginRank_Two.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineLoginRank_Two" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label Text="<%$ Resources:Language,LblRoleLoginNumberStatis %>" runat="server"></asp:Label>
        </div>
        <div class="search">
            ...
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                  ...
                  <%--  <asp:TemplateField HeaderText="角色名称">--%>
                    <asp:BoundField DataField="F_TradeCount" HeaderText="<%$ Resources:Language,LblLoginNumber %>" />
                </Columns>
