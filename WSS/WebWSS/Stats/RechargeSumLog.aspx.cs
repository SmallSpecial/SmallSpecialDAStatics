...
{
    public partial class RechargeSumLog : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT CONVERT(VARCHAR(100),F_InsertTime,23) F_InsertTime,SUM(F_Price) SumAmount,COUNT(DISTINCT F_UserID) PeopleCount,COUNT(F_UserID) Count
FROM LKSV_5_UserCoreDB_0_1.[UserCoreDB].[dbo].[T_Deposit_Verify_Result_Log] WHERE F_DepositResult=1
GROUP BY CONVERT(VARCHAR(100),F_InsertTime,23) having CONVERT(VARCHAR(100),F_InsertTime,23)>='" + searchdateB.ToString(SmallDateTimeFormat) + "' and CONVERT(VARCHAR(100),F_InsertTime,23)<='" + searchdateE.ToString(SmallDateTimeFormat)+"'";
            ...
            //}
            sql += " order by F_InsertTime desc";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.Footer)
                {
                    ...
                    e.Row.Cells[1].Text = "10";
                    e.Row.Cells[2].Text = "20";
                    e.Row.Cells[3].Text = "20";
