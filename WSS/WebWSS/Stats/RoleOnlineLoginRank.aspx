<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineLoginRank.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineLoginRank" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblRoleOnlineLoginRank %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_UserName" HeaderText="<%$Resources:Language,UserName %>" />
                    ...
                    <asp:BoundField DataField="F_LoginIP" HeaderText="<%$Resources:Language,LblLoginIpNum %>" />
