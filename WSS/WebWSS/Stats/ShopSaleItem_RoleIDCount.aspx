<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleItem_RoleIDCount.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleItem_RoleIDCount" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; 角色名称:<asp:TextBox ID="tboxRoleName" runat="server" Width="100px" MaxLength="10"></asp:TextBox>
