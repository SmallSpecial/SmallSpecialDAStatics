<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLose.aspx.cs" Inherits="WebWSS.Stats.UserLose" %>
        ...
        <div class="gridv">
         <asp:Label ID="lblerro" runat="server" Text="提示:没有相关信息!" ForeColor="#CC0066"></asp:Label>
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                PageSize="25">
                <Columns>
                    <asp:BoundField DataField="F_ID" HeaderText="<%$Resources:Language,LblDate %>" SortExpression="F_ID" ItemStyle-Width="100" />
