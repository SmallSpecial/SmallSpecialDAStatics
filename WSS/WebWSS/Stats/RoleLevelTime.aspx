<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLevelTime.aspx.cs"
    Inherits="WebWSS.Stats.RoleLevelTime" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label  runat="server" Text=" <%$Resources:Language,LblLeveTimeConsumingStatis %>"></asp:Label>
        ...
        <div class="titletip">
            ...
            <b><asp:Label  runat="server" Text="<%$Resources:Language,LblUnitWithMinute %>"></asp:Label></b>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="<%$Resources:Language,LblAvg %>" />
                </Columns>
