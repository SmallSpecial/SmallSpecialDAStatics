<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldLog.aspx.cs" Inherits="WebWSS.Stats.GoldLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text=" <%$Resources:Language,LblGoldLog %>"></asp:Label>
        ...
        <div class="search">
            ...
            <asp:Label ID="lblPARA_1" runat="server" Text="<%$Resources:Language,LblPathWay %>"></asp:Label>
            <asp:TextBox ID="txtPARA_1" runat="server"></asp:TextBox>
            <asp:Label ID="lblOPID" runat="server" Text="<%$Resources:Language,LblCurrencyType %>"></asp:Label>
            <asp:DropDownList ID="ddlOPID" runat="server">
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PARA_1" HeaderText="<%$Resources:Language,LblPathWay %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblPathWay %>" >
                        <ItemStyle Width="130px" />
                        <ItemTemplate>
                            <%#GetWay(Eval("OPID").ToString(),Eval("PARA_1").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="PARA_2" HeaderText="<%$Resources:Language,LblChange %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblCurrencyType %>" >
                        <ItemStyle Width="130px" />
                        <ItemTemplate>
