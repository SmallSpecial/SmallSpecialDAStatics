<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopQuery.aspx.cs" Inherits="WebWSS.Stats.ShopQuery" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="商城统计>>商城日志查询"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            商城类型:<asp:DropDownList ID="DropDownListCType" runat="server" Width="120">
            ...
            &nbsp; 道具编号:<asp:TextBox ID="tboxPARA_1" runat="server" Width="90px" MaxLength="16"></asp:TextBox>
            &nbsp;
                ...
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="商城类型">
                            ...
                            <ItemTemplate>
                                <%#GetTypeName(DropDownListCType, Eval("OPID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="PARA_2" HeaderText="销售道具数量">
                            <ItemStyle Width="80px" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="销售备注">
                            <ItemTemplate>
