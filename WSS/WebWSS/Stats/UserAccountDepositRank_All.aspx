<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountDepositRank_All.aspx.cs"
    Inherits="WebWSS.Stats.UserAccountDepositRank_All" %>
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_GiftMoney" HeaderText="赠送钱数"></asp:BoundField>
                        <asp:BoundField DataField="F_Count" HeaderText="充值次数"></asp:BoundField>
                    </Columns>
