<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskFinishRankRT.aspx.cs"
    Inherits="WebWSS.Stats.TaskFinishRankRT" %>
...
<body>
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblRoleRepeactFinshTaskRank %>"></asp:Label>
        </div>
        <div class="search">
