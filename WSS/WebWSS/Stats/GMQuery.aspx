<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GMQuery.aspx.cs" Inherits="WebWSS.Stats.GMQuery" EnableEventValidation="false" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" <%$Resources:Language,LblGmStatis %>"></asp:Label>
            >><asp:Label runat="server" Text="<%$Resources:Language,LblGMLogQuery %>"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblQueryTime %>"></asp:Label>
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblOperateType %>"></asp:Label><asp:DropDownList ID="DropDownListCType" runat="server" >
            ...
            <asp:TextBox ID="tboxCID" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblOperateDetail %>"></asp:Label>
            <asp:TextBox ID="tboxContent" runat="server" Width="180px" MaxLength="60"></asp:TextBox>
        ...
        <div class="gridv">
         ...
         <%--               <asp:BoundField DataField="ID" HeaderText="日志编号" DataFormatString="{0}">
                        ...
                        <asp:BoundField DataField="OPID" HeaderText="<%$Resources:Language,LblOperateNo %>">
...
<%--                        <asp:BoundField DataField="PARA_1" HeaderText="参数1">
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language,LblOperateDetail %>">
                            <ItemTemplate>
