<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestSex.aspx.cs"
    Inherits="WebWSS.Stats.QuestSex" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
                <asp:Label ID="LabelTitle" runat="server" Text=" 问卷调查>>"></asp:Label> <asp:Label ID="lblTitle" runat="server" Text=""></asp:Label>
        </div><uc2:ControlChartSelect ID="ControlChartSelect1" runat="server" OnSelectChanged="ControlChartSelect_SelectChanged" UsePie=true />
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_KeyTitle" HeaderText="选择项" >
                    <ItemStyle Width="500px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="F_AnswerNum" HeaderText="数 量" />
                    <asp:BoundField HeaderText="比 例" />
                </Columns>
            ...
            <uc3:ControlChart ID="ControlChart1" runat="server" Visible="False" />
             <span style="display:none" ><asp:Label ID="lblinfo" runat="server" Text="<%$Resources:Language,Tip_Sign %>" ForeColor="#FF6600"></asp:Label></span>
        </div>
    </div>
    </form>
</body>
