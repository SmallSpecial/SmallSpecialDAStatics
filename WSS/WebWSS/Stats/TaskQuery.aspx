<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskQuery.aspx.cs" Inherits="WebWSS.Stats.TaskQuery" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblEventType %>"></asp:Label>:<asp:DropDownList ID="DropDownListCType" runat="server" Width="140">
                <asp:ListItem  Text="<%$Resources:Language,LblAllType %>"></asp:ListItem>
            </asp:DropDownList>
            ...
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblUserNo %>"></asp:Label>:<asp:TextBox ID="tboxUID" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            ...
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblTaskNo %>"></asp:Label>:<asp:TextBox ID="tboxPARA_1" runat="server" Width="40px" MaxLength="6"></asp:TextBox>
            &nbsp; 描述:<asp:TextBox ID="tboxContent" runat="server" Width="100px" MaxLength="60"></asp:TextBox>
        ...
        <div class="gridv">
            ...
            <%--            <asp:BoundField DataField="ID" HeaderText="日志编号" DataFormatString="{0}">
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language,LblTaskName %>" >
                            <ItemTemplate>
                                <%#GetTaskName(Eval("PARA_1").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$Resources:Language,LblTaskType %>">
                        <ItemStyle Width="80px" />
                            <ItemTemplate>
                                <%#GetTType(Eval("PARA_2").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="OP_BAK" HeaderText="描述" />
