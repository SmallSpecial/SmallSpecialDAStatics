<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GSS_CustServ_Day.aspx.cs" Inherits="WebWSS.Stats.GSS_CustServ_Day" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 客服统计>>客服在线咨询统计"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                <asp:BoundField DataField="时间" HeaderText="<%$Resources:Language,LblTime %>" DataFormatString="{0:yyyy-MM-dd}" />
                    <asp:BoundField DataField="客服" HeaderText="客 服" />
                    <asp:BoundField DataField="回复" HeaderText="回复数量" />
                    <asp:BoundField DataField="接收" HeaderText="接收数量" DataFormatString="{0:#,#0}" />
                    <asp:BoundField DataField="结束" HeaderText="结束数量" DataFormatString="{0:#,#0}" />
                    <asp:BoundField DataField="工单" HeaderText="咨询工单数量" DataFormatString="{0:#,#0}" />
                </Columns>
