<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelClothesLog.aspx.cs" Inherits="WebWSS.Stats.ModelClothesLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblModelClothesLog %>"></asp:Label>
        ...
        <div class="search">
            ...
            <asp:Label ID="lblRoleId" runat="server" Text="<%$Resources:Language,LblRoleNo %>" Visible="false"></asp:Label>
            <asp:TextBox ID="tbRoleId" runat="server" Visible="false"></asp:TextBox>

            <asp:Label ID="lblPARA_1" runat="server" Text="PARA_1" Visible="false"></asp:Label>
            <asp:TextBox ID="txtPARA_1" runat="server" Visible="false"></asp:TextBox>
            <asp:Label ID="lblPARA_2" runat="server" Text="PARA_2" Visible="false"></asp:Label>
            <asp:TextBox ID="txtPARA_2" runat="server" Visible="false"></asp:TextBox>
     ...
     <asp:Label ID="lblDeType" runat="server" Text="43" Visible="true"></asp:Label>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblRoleJob %>">
                        <ItemTemplate>
                            <%#GetPro(Eval("PARA_2").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="<%$Resources:Language,LblOPType %>">
                        <ItemTemplate>
                           <asp:Label ID="OP" Text="<%$Resources:Language,LblActivate %>" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblModelClothesType %>">
                        <ItemTemplate>
                            <%#GetOPTYPE(Eval("OP_TYPE").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblModelClothesParams %>">
                        <ItemTemplate>
                            <%#GetOPTYPEITEMS(Eval("OP_TYPE").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
