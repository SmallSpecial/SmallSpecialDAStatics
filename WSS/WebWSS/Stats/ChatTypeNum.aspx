<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatTypeNum.aspx.cs" Inherits="WebWSS.Stats.ChatTypeNum" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="  <%$Resources:Language,LblChatStatis %>"></asp:Label>>>聊天数量统计
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="时间" HeaderText="<%$Resources:Language,LblTime %>" DataFormatString="{0}" />
