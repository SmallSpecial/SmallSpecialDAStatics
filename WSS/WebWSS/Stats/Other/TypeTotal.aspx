<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeTotal.aspx.cs" Inherits="WebWSS.Stats.Other.TypeTotal" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; <asp:Label runat="server" Text="<%$ Resources:Language,LblStaticTime %>"></asp:Label>:
            ...
            <asp:TextBox ID="tboxTimeE" runat="server" Width="120px" MaxLength="10"></asp:TextBox>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblActiveName %>">
                        <ItemTemplate>
                            <%# GetTaskName(Eval("F_PARA_1").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="<%$Resources:Language,LblLoginerNum %>" />
                    <asp:BoundField HeaderText="<%$Resources:Language,LblJoinerNum %>" DataField="F_InRoleCount" />
                    <asp:BoundField HeaderText="<%$Resources:Language,LblJoinSum %>" DataField="F_InCount" Visible="false" />
                </Columns>
