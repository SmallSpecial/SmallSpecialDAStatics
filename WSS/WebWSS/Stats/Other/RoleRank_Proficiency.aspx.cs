...
{
    public partial class RoleRank_Proficiency : BasePage
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT TOP 100 F_BigZone,F_ZoneID,F_UserID,F_RoleID,F_RoleLevel,F_TradeCount,F_MoneyCount FROM T_Other_GSLog_Rank with(nolock) WHERE 1=1 " + sqlwhere + " order by F_TradeCount desc";
