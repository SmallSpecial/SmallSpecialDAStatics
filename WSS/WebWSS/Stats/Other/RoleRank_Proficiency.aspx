<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRank_Proficiency.aspx.cs"
    Inherits="WebWSS.Stats.Other.RoleRank_Proficiency" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="角色等级" DataField="F_RoleLevel" DataFormatString="{0}级" />
                    <asp:BoundField HeaderText="精练次数" DataField="F_TradeCount" DataFormatString="{0}次" />
                </Columns>
