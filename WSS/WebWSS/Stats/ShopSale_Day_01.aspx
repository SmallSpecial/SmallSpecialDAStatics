<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSale_Day_01.aspx.cs"
    Inherits="WebWSS.Stats.ShopSale_Day_01" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城统计>>商城交易笔数统计(天)"></asp:Label>
        </div>
        <div class="search">
