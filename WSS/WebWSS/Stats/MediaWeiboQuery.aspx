<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaWeiboQuery.aspx.cs" Inherits="WebWSS.Stats.MediaWeiboQuery" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="推广统计>>微博查询"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
           ...
           <%-- 事件类型:--%><asp:DropDownList ID="DropDownListCType" runat="server" Width="120" Visible=false>
            ...
            &nbsp; 帐户编号:<asp:TextBox ID="tboxUID" runat="server" Width="40px" MaxLength="6"></asp:TextBox>
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblUserNo %>"></asp:Label>:<asp:TextBox ID="tboxCID" runat="server" Width="40px" MaxLength="6"></asp:TextBox>
            <%--&nbsp; 事件编号:--%><asp:TextBox ID="tboxOPID" runat="server" Width="40px" MaxLength="6" Visible=false>50102</asp:TextBox>
            &nbsp; 等级:<asp:TextBox ID="tboxPARA_1" runat="server" Width="90px" MaxLength="16"></asp:TextBox>
            ...
            <%--            <asp:BoundField DataField="ID" HeaderText="日志编号" DataFormatString="{0}">
                 ...
                 <%--       <asp:BoundField DataField="OPID" HeaderText="事件编号">
                        ...
                        <asp:TemplateField     HeaderText="<%$Resources:Language,LblEventType %>" >
                            <ItemStyle Width="120px" />
                            <ItemTemplate>
                                <%#Eval("UID").ToString().Trim() == "" ? "" : "微博转发"%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="PARA_1" HeaderText="角色等级">
                            <ItemStyle Width="80px" />
                        </asp:BoundField>
