<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationLevelRank.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationLevelRank" %>
            ...
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="rownum" HeaderText="<%$Resources:Language,LblRank %>" ItemStyle-Width="80px" DataFormatString="<%$Resources:Language,Msg_RankFormat %>">
                     ...
                     <asp:TemplateField ><%--HeaderText="猎魔者"--%>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID1").ToString().Length == 0 ? "" :GetResource("LblNo")+ " :" + Eval("F_RoleID1")+" " +GetResource("LblLevel")+ " :" + Eval("F_Level1") + " <br />"+GetResource("LblExp")+":" + Eval("F_Experience1") + "<br/>" + GetZoneName(Eval("F_BigZone1"), Eval("F_ZoneID1")) +"<br/>"+ GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime1") +"<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime1") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level1" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Experience1" HeaderText="<%$ Resources:Language,LblExp %>" />
                    <asp:TemplateField><%--魔导师--%>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#">
                                ...
                                <span>
                                    <%#Eval("F_RoleID2").ToString().Length == 0 ? "" : GetResource("LblNo")+ ":" + Eval("F_RoleID2")+" "  +GetResource("LblLevel")+ " :" + Eval("F_Level2") + " <br />"+GetResource("LblExp")+":" + Eval("F_Experience2") + "<br/>" + GetZoneName(Eval("F_BigZone2"),Eval("F_ZoneID2"))  +"<br/>"+GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime2") +"<br/>"+ GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime2") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level2" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Experience2" HeaderText="<%$ Resources:Language,LblExp %>" />
                    <asp:TemplateField ><%--HeaderText="龙战士"--%>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID3").ToString().Length == 0 ? "" :GetResource("LblNo")+ ":" + Eval("F_RoleID3") +" " + GetResource("LblLevel")+ " :" + Eval("F_Level3") + " <br />"+GetResource("LblExp")+":" + Eval("F_Experience3") + "<br/>" + GetZoneName(Eval("F_BigZone3"), Eval("F_ZoneID3"))  +"<br/>"+ GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime3") +"<br/>"+ GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime3") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level3" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Experience3" HeaderText="<%$ Resources:Language,LblExp %>" />
                    <asp:TemplateField ><%--HeaderText="召唤师"--%>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID4").ToString().Length == 0 ? "" :GetResource("LblNo")+ ":" + Eval("F_RoleID4")+" "  + GetResource("LblLevel")+ " :" + Eval("F_Level4") + " <br />"+GetResource("LblExp")+":" + Eval("F_Experience4") + "<br/>" + GetZoneName(Eval("F_BigZone4"), Eval("F_ZoneID4"))  +"<br/>"+ GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime4") +"<br/>"+ GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime4") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level4" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Experience4" HeaderText="<%$ Resources:Language,LblExp %>" />
                    <asp:TemplateField HeaderText="<%$ Resources:Language,LblAllVocation %>">
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID99").ToString().Length == 0 ? "" :GetResource("LblNo")+ ":" + Eval("F_RoleID99")+" "  + GetResource("LblLevel")+ " :" + Eval("F_Level99") + " <br />"+GetResource("LblExp")+":" + Eval("F_Experience99") + "<br/>" + GetZoneName(Eval("F_BigZone99"), Eval("F_ZoneID99"))  +"<br/>"+ GetResource("LblUpGradeTime") +" :"+ Eval("F_LevelUpTime99") +"<br/>"+ GetResource("LblUpdateTime")+ " :"+ Eval("F_LastTime99") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level99" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Experience99" HeaderText="<%$ Resources:Language,LblExp %>" />
                </Columns>
            ...
            <div style="display: none">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_Level1" HeaderText="猎魔者" />
                        <asp:BoundField DataField="F_Level2" HeaderText="魔导师" />
                        <asp:BoundField DataField="F_Level3" HeaderText="龙战士" />
                        <asp:BoundField DataField="F_Level4" HeaderText="召唤师" />
