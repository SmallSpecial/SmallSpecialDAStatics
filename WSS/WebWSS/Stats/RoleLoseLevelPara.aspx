<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLoseLevelPara.aspx.cs"
    Inherits="WebWSS.Stats.RoleLoseLevelPara" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblLoseLevelStatis %>"></asp:Label>
        </div>
        <div class="search">
