<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineIPRank.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineIPRank" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblRoleOnlineIpRank %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LoginIP" HeaderText="<%$Resources:Language,LblLoginIp %>" />
                    <asp:BoundField DataField="F_LoginNum" HeaderText="<%$Resources:Language,LblLoginNumber %>" />
                    <asp:BoundField DataField="F_UserName" HeaderText="<%$Resources:Language,LblUserNum %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblLoginAddress %>">
                        <ItemTemplate>
                            <%#"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + GetIPLocation(Eval("F_LoginIP"))%>
                        </ItemTemplate>
