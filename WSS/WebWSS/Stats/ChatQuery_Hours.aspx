<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatQuery_Hours.aspx.cs"
    Inherits="WebWSS.Stats.ChatQuery_Hours" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; <asp:Label runat="server" Text="<%$Resources:Language,LblUnit_Hour %>"></asp:Label>:<asp:TextBox ID="txtHourse" runat="server" Width="180px" MaxLength="60"></asp:TextBox>
        ...
        <div class="titletip">
            ...
            <asp:Label ID="lblEncoding" runat="server" Text="<%$Resources:Language,LblUnit_Hour %>" Visible="true"></asp:Label>
            <asp:Label ID="lblDecoding" runat="server" Text="<%$Resources:Language,LblCodeOpen %>" Visible="true"></asp:Label>
        </div>
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="1000">
                    <Columns>
                        ...
                        <asp:BoundField DataField="RCOUNT" HeaderText=" <%$Resources:Language,LblFrequency %>">
