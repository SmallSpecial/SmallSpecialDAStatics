<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLoseTimeAll.aspx.cs"
    Inherits="WebWSS.Stats.RoleLoseTimeAll" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblCumulativeTimeLostStatis %>"></asp:Label>
        </div>
        <div class="search">
