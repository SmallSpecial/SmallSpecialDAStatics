<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationLevel.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationLevel" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
             ...
             <asp:Label ID="Label1" runat="server" Text=" <%$Resources:Language,LblVocationLevelStatis %>"></asp:Label>
        </div>
        <div class="search">
