<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationLevelParaGrow.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationLevelParaGrow" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label ID="Label1" runat="server" Text=" <%$Resources:Language,LblLevelBetweenStais %>"></asp:Label>
        </div>
        <div class="search">
