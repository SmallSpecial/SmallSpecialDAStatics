<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemDropDayNow.aspx.cs" Inherits="WebWSS.Stats.ItemDropDayNow" %>
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
           ...
           <%-- 线路:--%><asp:DropDownList ID="DropDownListArea3" runat="server" Width="120" Visible="False">
            ...
            &nbsp;
             <asp:Literal runat="server" Text="<%$ Resources:Language,LblStaticTime %>"></asp:Literal>:<asp:TextBox ID="tboxTimeB" runat="server" Width="80px" MaxLength="10"></asp:TextBox><img src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'>
                          <asp:Literal runat="server" Text="<%$ Resources:Language,LblEndTime %>"></asp:Literal>:<asp:TextBox ID="tboxTimeE" runat="server" Width="80px" MaxLength="10"></asp:TextBox><img src='../img/Calendar.gif' border='0' style='padding-top: 10px' align='absmiddle'>
