...
{
    public partial class ChatRoleRpeatRank : Admin_Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Detail")
            {
                ...
                string url = "ChatQuery.aspx?cid=" + datakey["F_RoleID"].ToString() + "&date=" + LabelTime.Text + "&bigzone=" + DropDownListArea1.SelectedValue + "&zone=" + DropDownListArea2.SelectedValue;
