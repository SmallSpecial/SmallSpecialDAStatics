...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 推广统计>>安装\卸载统计"></asp:Label>
        </div>
        <div class="search">
           <%-- 大区:--%>
            ...
            游戏名称:<asp:DropDownList ID="DropDownList1" runat="server" Width="120"  >
                <asp:ListItem>所有游戏</asp:ListItem>
                <asp:ListItem>寻龙记</asp:ListItem>
            </asp:DropDownList>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="安装" HeaderText="安装量" />
                    <asp:BoundField DataField="卸载" HeaderText="卸载量" />
                    <asp:BoundField DataField="下载" HeaderText="下载量" />
                </Columns>
