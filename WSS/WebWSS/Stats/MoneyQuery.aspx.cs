...
{
    public partial class MoneyQuery : Admin_Page
    {
        ...
        protected void ddlOPID_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlOPID.SelectedIndex == 1)
            {
                ddlPara1Type.Items.Clear();
                ddlPara1Type.Items.Add(new ListItem("全部选项", ""));
                ddlPara1Type.Items.Add(new ListItem("拾取", "4"));
                ddlPara1Type.Items.Add(new ListItem("任务奖励", "5"));
                ddlPara1Type.Items.Add(new ListItem("创建帮派", "6"));
                ddlPara1Type.Items.Add(new ListItem("切换场景", "7"));
                ddlPara1Type.Items.Add(new ListItem("GM用指令修改的", "8"));
                ddlPara1Type.Items.Add(new ListItem("系统后台发奖等", "9"));
                ddlPara1Type.Items.Add(new ListItem("NPC交易", "10"));
                ddlPara1Type.Items.Add(new ListItem("修理装备花费", "11"));
                ddlPara1Type.Items.Add(new ListItem("创建家族", "12"));
                ddlPara1Type.Items.Add(new ListItem("技能学习", "13"));
                ddlPara1Type.Items.Add(new ListItem("法宝升星", "14"));
                ddlPara1Type.Items.Add(new ListItem("侍卫复活", "16"));
                ddlPara1Type.Items.Add(new ListItem("答题得钱", "17"));
                ddlPara1Type.Items.Add(new ListItem("装备精炼", "18"));
                ddlPara1Type.Items.Add(new ListItem("装备/法宝融合", "19"));
                ddlPara1Type.Items.Add(new ListItem("宝石合成", "20"));
                ddlPara1Type.Items.Add(new ListItem("装备重铸", "21"));
                ddlPara1Type.Items.Add(new ListItem("接奖励任务扣除", "22"));
                ddlPara1Type.Items.Add(new ListItem("装备鉴定", "23"));
                ddlPara1Type.Items.Add(new ListItem("lgc道具包给的", "24"));
                ddlPara1Type.Items.Add(new ListItem("法宝升星", "25"));
                ddlPara1Type.Items.Add(new ListItem("战场积分兑换", "26"));
                ddlPara1Type.Items.Add(new ListItem("奖励兑换", "27"));
                ddlPara1Type.Items.Add(new ListItem("邮资", "28"));
                ddlPara1Type.Items.Add(new ListItem("任务奖励", "29"));
                ddlPara1Type.Items.Add(new ListItem("法宝技能激活", "30"));
                ddlPara1Type.Items.Add(new ListItem("拍卖行手续费", "31"));
                ddlPara1Type.Items.Add(new ListItem("直接完成洪荒任务扣钱", "32"));
                ddlPara1Type.Items.Add(new ListItem("刷新洪荒任务扣钱", "33"));
                ddlPara1Type.Items.Add(new ListItem("刷新洪荒任务星级扣钱", "34"));
                ddlPara1Type.Items.Add(new ListItem("LGC对金钱的操作", "35"));
                ddlPara1Type.Items.Add(new ListItem("军团升级消耗", "36"));
                ddlPara1Type.Items.Add(new ListItem("天启之轮", "37"));
                ddlPara1Type.Items.Add(new ListItem("装备精炼转移", "44"));

            }
            else if (ddlOPID.SelectedIndex == 2)
            {
                ddlPara1Type.Items.Clear();
                ddlPara1Type.Items.Add(new ListItem("全部选项", ""));
                ddlPara1Type.Items.Add(new ListItem("拾取", "0"));
                ddlPara1Type.Items.Add(new ListItem("GM用指令修改的", "1"));
                ddlPara1Type.Items.Add(new ListItem("任务奖励", "3"));
                ddlPara1Type.Items.Add(new ListItem("洪荒奖励", "4"));
                ddlPara1Type.Items.Add(new ListItem("装备精炼", "6"));
                ddlPara1Type.Items.Add(new ListItem("装备/法宝融合", "8"));
                ddlPara1Type.Items.Add(new ListItem("法宝升档", "9"));
                ddlPara1Type.Items.Add(new ListItem("法宝升星", "10"));
                ddlPara1Type.Items.Add(new ListItem("装备精炼转移", "15"));
            }
            else
            {
                ddlPara1Type.Items.Clear();
