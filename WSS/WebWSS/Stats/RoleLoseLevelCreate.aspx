<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLoseLevelCreate.aspx.cs" Inherits="WebWSS.Stats.RoleLoseLevelCreate" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblLoseLevelStatis %>" />
        </div>
        <div class="search">
            ...
            &nbsp;<asp:Literal runat="server" Text="创建时间开始"></asp:Literal>:
            ...
            <asp:Literal runat="server" Text="创建时间结束"></asp:Literal>:
            ...
            &nbsp;
            <span style="color:red">*流失统计规则：3天以上未登录的用户</span>
        </div>
        <div class="titletip">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                ShowFooter="True">
                <Columns>
                    <asp:BoundField DataField="等级" HeaderText="等级" DataFormatString="{0} 级" />
            ...
            <asp:Label ID="lblerro" runat="server" Text="<%$Resources:Language,Tip_Nodata %>" ForeColor="#FF6600"></asp:Label>
             <span style="display:none" >
                 <asp:Label   runat="server" Text="<%$Resources:Language,Tip_Sign %>" ForeColor="#FF6600"></asp:Label>
