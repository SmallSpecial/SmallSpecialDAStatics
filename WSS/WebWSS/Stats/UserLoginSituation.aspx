<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginSituation.aspx.cs" Inherits="WebWSS.Stats.UserLoginSituation" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="登录LOG"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LoginTime" HeaderText="用户登录时间" />
                    <asp:BoundField DataField="F_ExitTime" HeaderText="用户退出时间" />
                    <asp:BoundField DataField="F_LoginIP" HeaderText="登录游戏的IP" />
                    <asp:BoundField DataField="F_Device_id" HeaderText="使用硬件固有ID" />
                </Columns>
