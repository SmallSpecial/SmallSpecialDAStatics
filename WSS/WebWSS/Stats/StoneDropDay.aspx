<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoneDropDay.aspx.cs" Inherits="WebWSS.Stats.StoneDropDay" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
                ...
                <asp:Label ID="LabelTitle" runat="server" Text=" 贵重物品掉落统计>>精炼石(宝石)"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="date" HeaderText="<%$Resources:Language,LblDate %>" HeaderStyle-Width="120px" />
                    ...
                    <asp:BoundField HeaderText="<%$Resources:Language,LblSum %>" />
                </Columns>
