<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemAttriDefence.aspx.cs"
    Inherits="WebWSS.Stats.ItemAttriDefence" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 道具统计>>极品属性统计(防御)"></asp:Label>
        </div>
        <div class="search">
