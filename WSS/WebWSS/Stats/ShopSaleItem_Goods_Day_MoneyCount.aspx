<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleItem_Goods_Day_MoneyCount.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleItem_Goods_Day_MoneyCount" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                AutoGenerateColumns="True" Font-Size="12px" Width="95%" OnSorting="GridView1_Sorting"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="商品名称">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("F_ItemExcelID", "{0}") %>'></asp:Label>
                            <%#GetTextName(Eval("F_ItemExcelID").ToString())%>
                            *
                             <%#Eval("F_ItemChildNum")%>
                        </ItemTemplate>
