<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeByTimeLog.aspx.cs" Inherits="WebWSS.Stats.RechargeByTimeLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text=" <%$Resources:Language,LblRechargeByTimeLog %>"></asp:Label>
        ...
        <div class="search">
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblPayState %>" Visible="false"></asp:Label>
            <asp:DropDownList ID="ddlDepositResult" runat="server" Width="120" Visible="false">
            </asp:DropDownList>
            &nbsp;
     ...
     <asp:Label ID="lblDeType" runat="server" Text="43" Visible="true"></asp:Label>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="Num" HeaderText="<%$Resources:Language,LblPeopleNum %>" />
                    <asp:BoundField DataField="F_TransactionID" HeaderText="<%$Resources:Language,LblOrderNum %>" />
                    <asp:BoundField DataField="F_Price" HeaderText="<%$Resources:Language,LblPaySumAmount %>" />
                </Columns>
                <PagerTemplate>
