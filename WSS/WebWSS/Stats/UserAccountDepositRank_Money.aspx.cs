...
{
    public partial class UserAccountDepositRank_Money : Admin_Page
    {
        ...
        public void bind()
        {
            string sqlStr = @"SELECT top 2000 ROW_NUMBER() OVER(order by SUM(F_TradeMoney) desc) as ROWNUM,F_UserID, SUM(F_TradeMoney) as F_TradeMoney
            ...
            sqlStr += " and F_TradeTime>='" + searchdateB.ToString("yyyy/MM/dd 00:00:00") + "' and F_TradeTime<='" + searchdateE.ToString("yyyy/MM/dd 23:59:59") + "' ";
