...
{
    public partial class UserAccountTradeAll : Admin_Page
    {
        ...
        public void bind()
        {
            string sqlStr = @"SELECT top 100 SUM(F_TradeMoney) as F_TradeMoney, Count(1) as F_Count,convert(varchar(10),F_TradeTime,112) as F_TradeTime
            FROM T_TradeMoneyLog with(nolock)";

            sqlStr += " where F_DESC='减钱成功' ";
            ...
            sqlStr += " group by convert(varchar(10),F_TradeTime,112) order by F_TradeTime asc";
