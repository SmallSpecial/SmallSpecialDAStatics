<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpsbattleRank.aspx.cs" Inherits="WebWSS.Stats.CorpsbattleRank" %>
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ObjectId" HeaderText="<%$ Resources:Language,LblCorpsNum %>" />
                    <asp:BoundField DataField="ObjectName" HeaderText="<%$ Resources:Language,LblCorpsN %>" />
                    <asp:BoundField DataField="ObjectSubName" HeaderText="<%$ Resources:Language,LblCDRName %>" />
                    <asp:BoundField DataField="ObjectSubIntInfo" HeaderText="<%$ Resources:Language,LblCorpsLevel %>" />
                    <asp:TemplateField HeaderText="<%$ Resources:Language,LblCamp %>">
                            <ItemTemplate>
                                <%#GetCampName(Eval("ObjectThdIntInfo").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
