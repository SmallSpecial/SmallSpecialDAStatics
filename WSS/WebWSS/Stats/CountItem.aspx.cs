...
{
    public partial class CountItem : Admin_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    LabelTitle.Text = "推广统计>>" + Request.QueryString["title"];
                }
        ...
        public void bind()
        {
            ...
            if (Request.QueryString["item"] != null)
            {
                ...
                itemStr = itemStr.Replace("+*+", "+'*'+");//由于在前段处理 字符串转义  +'*'+较为复杂，此处直接修改后台替换
            }
            ...
            string sql = "";
            sql = @"SELECT  isnull(" + itemStr + ",'未知') as item,count(1) as num  FROM T_CountDetail where F_Time>='" + searchdateB.ToString(SmallDateTimeFormat)   + "' and F_Time<='" + searchdateE.ToString(SmallDateTimeFormat)   + "' ";
            ...
            //}
            sql += "group by  " + itemStr + " order by num desc";
