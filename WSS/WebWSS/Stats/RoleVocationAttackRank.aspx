<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationAttackRank.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationAttackRank" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text=" <%$Resources:Language,LblAttackRankStatis %>"></asp:Label>
        </div>
        <div class="search">
                    ...
                    <asp:TemplateField >
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                <%#GetRoleName(Eval("F_RoleID0").ToString())%>
                                <span>
                                    <%#Eval("F_RoleID0").ToString().Length == 0 ? "" : GetResource("LblNo")+ " :" + Eval("F_RoleID0") + GetResource("LblLevel")+ " :" + Eval("F_Level0") + " <br />"+GetResource("LblAttack")+":" + Eval("F_Attack0")  +"<br/>"+GetZoneName(Eval("F_BigZone0"), Eval("F_ZoneID0")) +"<br/>"+ GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime0") + "<br/>"+GetResource("LblUpdateTime")+ " :"  + Eval("F_LastTime0") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level0" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Attack0" HeaderText="<%$ Resources:Language,LblAttack %>" />
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID1").ToString().Length == 0 ? "" :GetResource("LblNo")+ " :"+ Eval("F_RoleID1") +GetResource("LblLevel")+ " :" + Eval("F_Level1") + " <br />"+GetResource("LblAttack")+":" + Eval("F_Attack1")  +"<br/>"+GetZoneName(Eval("F_BigZone1"), Eval("F_ZoneID1")) +"<br/>"+GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime1") + "<br/>"+GetResource("LblUpdateTime")+ " :"  + Eval("F_LastTime1") + "  "%></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level1" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Attack1" HeaderText="<%$ Resources:Language,LblAttack %>" />
                     <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID2").ToString().Length == 0 ? "" :GetResource("LblNo")+ " :"+ Eval("F_RoleID2") + GetResource("LblLevel")+ " :"  + Eval("F_Level2") + " <br />"+GetResource("LblAttack")+":" + Eval("F_Attack2")  +"<br/>"+ GetZoneName(Eval("F_BigZone2"), Eval("F_ZoneID2")) +"<br/>"+GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime2") + "<br/>"+GetResource("LblUpdateTime")+ " :"  + Eval("F_LastTime2") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level2" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Attack2" HeaderText="<%$ Resources:Language,LblAttack %>" />
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID3").ToString().Length == 0 ? "" : GetResource("LblNo")+ " :"+ Eval("F_RoleID3") + GetResource("LblLevel")+ " :" + Eval("F_Level3")+ " <br />"+GetResource("LblAttack")+":" + Eval("F_Attack3") +"<br/>"+ GetZoneName(Eval("F_BigZone3"), Eval("F_ZoneID3"))  +"<br/>"+ GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime3") +"<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime3") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level3" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Attack3" HeaderText="<%$ Resources:Language,LblAttack %>" />
                    <asp:TemplateField HeaderText="<%$ Resources:Language,LblAllVocation %>">
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                <%#GetRoleName(Eval("F_RoleID99").ToString())%>
                                <span>
                                    <%#Eval("F_RoleID99").ToString().Length == 0 ? "" : GetResource("LblNo")+ " :" + Eval("F_RoleID99") +GetResource("LblLevel")+ " :" + Eval("F_Level99") + " <br />"+GetResource("LblAttack")+":" + Eval("F_Attack99")  +"<br/>"+ GetZoneName(Eval("F_BigZone99"), Eval("F_ZoneID99")) +"<br/>"+GetResource("LblUpGradeTime") +" :" + Eval("F_LevelUpTime99") + "<br/>"+GetResource("LblUpdateTime")+ " :"  + Eval("F_LastTime99") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="F_Level99" HeaderText="<%$ Resources:Language,LblLevel %>" />
                    <asp:BoundField DataField="F_Attack99" HeaderText="<%$ Resources:Language,LblAttack %>" />
                </Columns>
            ...
            <div style="display: none">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_Attack0" HeaderText="猎魔者" />
                        <asp:BoundField DataField="F_Attack1" HeaderText="魔导师" />
                        <asp:BoundField DataField="F_Attack2" HeaderText="龙战士" />
                        <asp:BoundField DataField="F_Attack3" HeaderText="召唤师" />
                        <asp:BoundField DataField="F_Attack99" HeaderText="全部" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
