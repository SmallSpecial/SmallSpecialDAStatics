...
{
    public partial class UserLoginSituation : Admin_Page
    {
        ...
        private string GetSum(DataView dv)
        {
            ...
            {
                i += Convert.ToInt32(dr["F_IPLoginNum"]);
            }
            return i.ToString();
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                //    //{
                //    //    sumi = Convert.ToDouble(e.Row.Cells[2].Text) / Convert.ToDouble(lblSum.Text);
                //    //}
                //    e.Row.Cells[3].Text = sumi.ToString("0.00%");
                //}
            }
            catch (System.Exception ex)
            {
