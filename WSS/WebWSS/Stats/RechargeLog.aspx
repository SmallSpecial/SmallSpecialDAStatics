<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeLog.aspx.cs" Inherits="WebWSS.Stats.RechargeLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblRechargeLog %>"></asp:Label>
        ...
        <div class="search">
            ...
            <asp:Label ID="lblTransactionID" runat="server" Text="<%$Resources:Language,LblOrderNumber %>"></asp:Label>
            <asp:TextBox ID="txtTransactionID" runat="server"></asp:TextBox>

            <asp:Label ID="lblProductID" runat="server" Text="<%$Resources:Language,LblProductID %>"></asp:Label>
            <asp:TextBox ID="txtProductID" runat="server"></asp:TextBox>

            <asp:Label runat="server" Text="<%$Resources:Language,LblPayState %>"></asp:Label>:
            <asp:DropDownList ID="ddlDepositResult" runat="server" Width="120">
            </asp:DropDownList>
            &nbsp;
        ...
        <div class="gridv" style="margin-right:100px">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_ProductID" HeaderText="<%$Resources:Language,LblProductID %>" />
                    <asp:BoundField DataField="F_Price" HeaderText="<%$Resources:Language,LblPayNum %>" />

                    <asp:BoundField DataField="F_InsertTime" HeaderText="<%$Resources:Language,LblPayTime %>" />
                    <asp:BoundField DataField="F_StoreName" HeaderText="<%$Resources:Language,LblStore %>" />
                    <asp:BoundField DataField="F_DepositResult" HeaderText="<%$Resources:Language,LblPayState %>" />
                </Columns>
