<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleItem_ExcelLevel.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleItem_ExcelLevel" %>
    ...
    <div class="main">
        ...
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            &nbsp; 商品名称:<asp:TextBox ID="tboxExcelName" runat="server" Width="100px" MaxLength="10"></asp:TextBox>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_ItemExcelID" HeaderText="商品编号" />
                    ...
                    <asp:BoundField DataField="F_RoleCount" HeaderText="购买角色数" />
