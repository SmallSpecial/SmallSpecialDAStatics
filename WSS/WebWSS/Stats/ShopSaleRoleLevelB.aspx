<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleRoleLevelB.aspx.cs" Inherits="WebWSS.Stats.ShopSaleRoleLevelB" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城统计>>角色购买统计"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_RoleLevel" HeaderText="角色等级" 
                        DataFormatString="{0} 级"  >
