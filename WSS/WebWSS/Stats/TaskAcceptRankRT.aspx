<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskAcceptRankRT.aspx.cs"
    Inherits="WebWSS.Stats.TaskAcceptRankRT" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblRoleRepeactAcceptTaskRank %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_Num" HeaderText="<%$Resources:Language,LblTaskAcceptNum %>" />
                </Columns>
