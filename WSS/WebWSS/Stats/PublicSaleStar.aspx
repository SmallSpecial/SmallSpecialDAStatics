<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicSaleStar.aspx.cs"
    Inherits="WebWSS.Stats.PublicSaleStar" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 拍卖行统计>>道具星级分布"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_Level" HeaderText="星级" DataFormatString="{0} 星" >
