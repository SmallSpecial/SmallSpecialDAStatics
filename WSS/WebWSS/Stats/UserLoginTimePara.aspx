<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginTimePara.aspx.cs"
    Inherits="WebWSS.Stats.UserLoginTimePara" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$Resources:Language,LblLgoinTimeParamStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="titletip">
           ...
           <asp:Label runat="server" Text="<%$Resources:Language,LblTime %>"></asp:Label>:<span class="tyellow">
          <asp:Label ID="LabelTime" runat="server" Text=""></asp:Label></span>
          <asp:Label runat="server" Text="<%$Resources:Language,LblUserSum %>"></asp:Label><asp:Label ID="lblSum" runat="server" Text="0"></asp:Label> </h7>
        </div>
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
<%--                    <asp:TemplateField HeaderText="在线时长">
                        <ItemTemplate>
                            <%#GetTimePara(Eval("F_TimePara"))%>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                    <asp:BoundField DataField="F_TimeParaT" HeaderText="<%$Resources:Language,LblLoginTimeWithHourUnit %>" />
                    <asp:BoundField DataField="F_UserNum" HeaderText="<%$Resources:Language,LblUserNum %>" />
                    <asp:BoundField HeaderText="<%$Resources:Language,LblProportion %>" />
                </Columns>
