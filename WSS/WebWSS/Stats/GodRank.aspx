<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GodRank.aspx.cs" Inherits="WebWSS.Stats.GodRank" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >>
            <asp:Label runat="server" Text=" <%$Resources:Language,LblGodRank %>"></asp:Label>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId1")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName1") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo1") + "<br/>" + GetResource("LblBreakThrough") +" :" + Eval("ObjectThdIntInfo1") +"<br/>"+GetResource("LblBattle")+ " :" + Eval("SortValue1") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo1" HeaderText="<%$Resources:Language,LblBreakThrough %>" />
                    <asp:BoundField DataField="SortValue1" HeaderText="<%$Resources:Language,LblBattle %>" />
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId2")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName2") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo2") + "<br/>" + GetResource("LblBreakThrough") +" :" + Eval("ObjectThdIntInfo2") +"<br/>"+GetResource("LblBattle")+ " :" + Eval("SortValue2") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo2" HeaderText="<%$Resources:Language,LblBreakThrough %>" />
                    <asp:BoundField DataField="SortValue2" HeaderText="<%$Resources:Language,LblBattle %>" />
                    <asp:TemplateField>
                        <HeaderTemplate><%#GetVacationTypeName("3")  %></HeaderTemplate>
                        <HeaderStyle Width="80px" />
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                <%#Eval("ObjectName3").ToString()%>
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId3")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName3") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo3") + "<br/>" + GetResource("LblBreakThrough") +" :" + Eval("ObjectThdIntInfo3") +"<br/>"+GetResource("LblBattle")+ " :" + Eval("SortValue3") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo3" HeaderText="<%$Resources:Language,LblBreakThrough %>" />
                    <asp:BoundField DataField="SortValue3" HeaderText="<%$Resources:Language,LblBattle %>" />
                    <asp:TemplateField>
                        <HeaderTemplate><%#GetVacationTypeName("4")  %></HeaderTemplate>
                        <HeaderStyle Width="80px" />
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                <%#Eval("ObjectName4").ToString()%>
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId4")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName4") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo4") + "<br/>" + GetResource("LblBreakThrough") +" :" + Eval("ObjectThdIntInfo4") +"<br/>"+GetResource("LblBattle")+ " :" + Eval("SortValue4") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo4" HeaderText="<%$Resources:Language,LblBreakThrough %>" />
                    <asp:BoundField DataField="SortValue4" HeaderText="<%$Resources:Language,LblBattle %>" />
                    <asp:TemplateField>
                        <HeaderTemplate><%#GetVacationTypeName("4")  %></HeaderTemplate>
                        <HeaderStyle Width="80px" />
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo") + "<br/>" + GetResource("LblBreakThrough") +" :" + Eval("ObjectThdIntInfo") +"<br/>"+GetResource("LblBattle")+ " :" + Eval("SortValue") + "  "%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo" HeaderText="<%$Resources:Language,LblBreakThrough %>" />
                    <asp:BoundField DataField="SortValue" HeaderText="<%$Resources:Language,LblBattle %>" />
                </Columns>
                <PagerTemplate>
            ...
            <div style="display: none">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ObjectId1" HeaderText="猎魔者" />
                        <asp:BoundField DataField="ObjectId2" HeaderText="魔导师" />
                        <asp:BoundField DataField="ObjectId3" HeaderText="龙战士" />
                        <asp:BoundField DataField="ObjectId4" HeaderText="召唤师" />
