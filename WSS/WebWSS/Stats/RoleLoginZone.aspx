<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleLoginZone.aspx.cs"
    Inherits="WebWSS.Stats.RoleLoginZone" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$ Resources:Language,LblRoleLoginSumStatis %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_InRoleCount" HeaderText="<%$ Resources:Language,LblRoleLoginSum %>" />
                </Columns>
