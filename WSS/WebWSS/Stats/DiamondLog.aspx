<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiamondLog.aspx.cs" Inherits="WebWSS.Stats.DiamondLog" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$Resources:Language,LblDiamondInfoLog %>"></asp:Label>
