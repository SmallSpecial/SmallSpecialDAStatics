<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRemain.aspx.cs" Inherits="WebWSS.Stats.RoleRemain" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblRoleRemain %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="50" ShowFooter="false">
                <Columns>
                    <asp:BoundField DataField="F_Date" HeaderText="<%$Resources:Language,LblDate %>" DataFormatString="{0:d}" />
                    <asp:BoundField DataField="F_Zone" HeaderText="<%$Resources:Language,LblZone %>" />
                    <asp:BoundField DataField="F_LoginNum" HeaderText="Sum" />
                    <asp:BoundField DataField="F_LoginDay1Num" HeaderText="D-1" />
                    <asp:BoundField DataField="F_LoginDay2Num" HeaderText="D-2" />
                    <asp:BoundField DataField="F_Remain2" HeaderText="<%$Resources:Language,LblRemainTwoDay %>" />
                    <asp:BoundField DataField="F_LoginDay3Num" HeaderText="D-3" />
                    <asp:BoundField DataField="F_Remain3" HeaderText="<%$Resources:Language,LblRemainThreeDay %>" />
                    <asp:BoundField DataField="F_LoginDay4Num" HeaderText="D-4" />
                    <asp:BoundField DataField="F_Remain4" HeaderText="<%$Resources:Language,LblRemainFourDay %>" />
                    <asp:BoundField DataField="F_LoginDay5Num" HeaderText="D-5" />
                    <asp:BoundField DataField="F_Remain5" HeaderText="<%$Resources:Language,LblRemainFiveDay %>" />
                    <asp:BoundField DataField="F_LoginDay6Num" HeaderText="D-6" />
                    <asp:BoundField DataField="F_Remain6" HeaderText="<%$Resources:Language,LblRemainSixDay %>" />
                    <asp:BoundField DataField="F_LoginDay7Num" HeaderText="D-7" />
                    <asp:BoundField DataField="F_Remain7" HeaderText="<%$Resources:Language,LblRemainSevenDay %>" />
                    <asp:BoundField DataField="F_LoginDay15Num" HeaderText="D-15" />
                    <asp:BoundField DataField="F_LoginDay30Num" HeaderText="D-30" />
                </Columns>
