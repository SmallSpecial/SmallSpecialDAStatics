<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationLevelGrow.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationLevelGrow" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label Text="<%$Resources:Language,LblRoleGrowStatic %>" runat="server" ></asp:Label>   
        </div>
        <div class="search">
