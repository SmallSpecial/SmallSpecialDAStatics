<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemDropDay.aspx.cs" Inherits="WebWSS.Stats.ItemDropDay" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 当天掉落统计(装备)"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="25" OnRowCreated="GridView1_RowCreated"
                ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="日期" HeaderText="<%$Resources:Language,LblDate %>" />
                    ...
                    <asp:BoundField DataField="斗仙" HeaderText="斗仙" />
                    ...
                    <asp:BoundField DataField="总计" HeaderText="<%$Resources:Language,LblSum %>" />
                </Columns>
                <SelectedRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#006699" Font-Size="12px" HorizontalAlign="Center" Font-Bold="True"
                    ForeColor="White" />
                <RowStyle HorizontalAlign="Center" ForeColor="#000066" />
                <FooterStyle BackColor="#005a8c" ForeColor="#FFFFFF" />
            ...
            职业选择:<asp:DropDownList ID="DropDownListVocation" runat="server" Width="120" 
                ...
                <asp:ListItem>斗仙</asp:ListItem>
                <asp:ListItem>花灵</asp:ListItem>
                <asp:ListItem>天师</asp:ListItem>
                <asp:ListItem>行者</asp:ListItem>
            </asp:DropDownList></span></h7>
            </div>
            <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
            ...
            <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
            ...
            <div class="titletip">
                <br />
                <span class="tyellow">黄色(5星)装备</span> [<%=DropDownListVocation.Text%>]
            </div>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
            ...
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
            ...
            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
            ...
            <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
            ...
            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" Font-Size="12px"
                Width="95%" CellPadding="3" BorderWidth="1px" BorderStyle="None" BackColor="White"
                BorderColor="#CCCCCC" PageSize="25" OnRowDataBound="GridView2_RowDataBound" ShowFooter="true">
                <Columns>
                    <asp:BoundField DataField="装备类别" HeaderText="装备类别" />
