<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldRoleStream.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldRoleStream" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
                ...
                <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>玩家流通排行"></asp:Label>
        </div>
        <div class="search">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="金币流通当天获得排行">
                        <ItemTemplate>
                            ...
                            <div style="float: left; text-align: left;">
                                <%#Eval("rownum0").ToString().Length > 0 ? "[用户:" + Eval("F_UserID0").ToString() + "角色:" + Eval("F_RoleID0").ToString() + " " + GetRoleName(Eval("F_RoleID0").ToString()) + "]" : ""%></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="金币流通当天消耗排行">
                        <ItemTemplate>
                            ...
                            <div style="float: left; text-align: left;">
                                <%#Eval("rownum0").ToString().Length > 0 ? "[用户:" + Eval("F_UserID1").ToString() + "角色:" + Eval("F_RoleID1").ToString() + " " + GetRoleName(Eval("F_RoleID1").ToString()) + "]" : ""%></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="金币流通当天结余排行">
                        <ItemTemplate>
                            ...
                            <div style="float: left; text-align: left;">
                                <%#Eval("rownum0").ToString().Length > 0 ? "[用户:" + Eval("F_UserID2").ToString() + "角色:" + Eval("F_RoleID2").ToString() + " " + GetRoleName(Eval("F_RoleID2").ToString()) + "]" : ""%></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
