...
{
    public partial class PublicSaleRankFight : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT  top 100  ROW_NUMBER() OVER(order by F_FightValue desc) AS rownum,  F_ExcelID, F_RoleID, F_RoleName, F_FightValue, F_SaleID
FROM         T_PublicSaleRankFight " + sqlwhere + @" order by F_FightValue desc";
