<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountDepositRank_Money.aspx.cs"
    Inherits="WebWSS.Stats.UserAccountDepositRank_Money" %>
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_TradeMoney" HeaderText="充值总钱数"></asp:BoundField>
                    </Columns>
