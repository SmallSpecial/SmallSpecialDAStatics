...
namespace WebWSS.Stats.Trade
{
    public partial class RoleRank : BasePage
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT TOP 100 ROW_NUMBER() OVER(order by F_TradeCount desc) AS rownum,  F_BigZone,F_ZoneID,F_UserID,F_RoleID,F_TradeCount,F_MoneyCount FROM T_Trade_GSLog_Rank with(nolock) WHERE 1=1 " + sqlwhere + "";
