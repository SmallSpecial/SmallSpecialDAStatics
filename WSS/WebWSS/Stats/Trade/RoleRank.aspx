<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRank.aspx.cs" Inherits="WebWSS.Stats.Trade.RoleRank" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField HeaderText="<%$Resources:Language,LblRank %>" DataField="rownum" DataFormatString="第{0}名" />
                    ...
                    <asp:BoundField HeaderText="交易金额" DataField="F_MoneyCount" DataFormatString="{0}元" />
                </Columns>
