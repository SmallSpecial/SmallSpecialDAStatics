<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineFlow.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineFlow" %>
    ...
    <div style="margin-left: 5px; margin-top: 0px;">
        <div>
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            <asp:DropDownList ID="DropDownListArea1" runat="server" Width="120" AutoPostBack="True"
             ...
             <asp:Label runat="server" Text="<%$Resources:Language,LblService %>"></asp:Label>:<asp:DropDownList ID="DropDownListArea2" runat="server" Width="120" AutoPostBack="False"
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                AllowPaging="True">
                <Columns>
                    <asp:BoundField DataField="F_Time" HeaderText="<%$Resources:Language,LblTime %>" DataFormatString="{0}点" />
                </Columns>
