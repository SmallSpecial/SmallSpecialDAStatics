...
{
    public partial class WeekKillRank : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT * FROM OPENQUERY ([LKSV_3_gsdata_db_"+bigZone+"_"+battleZone+"],'SELECT * FROM (SELECT RankId,RankSubType,RankNumber,ObjectId,ObjectName,ObjectIntInfo,ObjectSubIntInfo,ObjectThdIntInfo,SortValue,UpdateTime FROM ranktable WHERE RankId=22 AND RankSubType=0) A  LEFT JOIN (SELECT RankId AS RankId1,RankSubType AS RankSubType1,RankNumber AS RankNumber1,ObjectId AS ObjectId1,ObjectName AS ObjectName1,ObjectIntInfo AS ObjectIntInfo1,ObjectSubIntInfo AS ObjectSubIntInfo1,ObjectThdIntInfo AS ObjectThdIntInfo1,SortValue AS SortValue1,UpdateTime AS UpdateTime1 FROM ranktable WHERE RankId=22 AND RankSubType=1) A1 ON A.RankNumber=A1.RankNumber1 LEFT JOIN (SELECT RankId AS RankId2,RankSubType AS RankSubType2,RankNumber AS RankNumber2,ObjectId AS ObjectId2,ObjectName AS ObjectName2,ObjectIntInfo AS ObjectIntInfo2,ObjectSubIntInfo AS ObjectSubIntInfo2,ObjectThdIntInfo AS ObjectThdIntInfo2,SortValue AS SortValue2,UpdateTime AS UpdateTime2 FROM ranktable WHERE RankId=22 AND RankSubType=2) A2 ON A.RankNumber=A2.RankNumber2')";
