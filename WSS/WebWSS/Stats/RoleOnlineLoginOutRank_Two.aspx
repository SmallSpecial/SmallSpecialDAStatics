<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineLoginOutRank_Two.aspx.cs"
    Inherits="WebWSS.Stats.RoleOnlineLoginOutRank_Two" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="<%$ Resources:Language,LblOnlineStatis %> "></asp:Label>>>
            <asp:Label runat="server" Text="<%$ Resources:Language,LblUserLogoutNumberRank %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_RoleName" HeaderText="<%$Resources:Language,LblRoleName %>" />
                    <%--<asp:TemplateField HeaderText="角色名称">
                        <ItemTemplate>
                            <%# GetRoleName(Eval("F_RoleID").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                    <asp:BoundField DataField="F_TradeCount" HeaderText="<%$Resources:Language,LblLogoutNumber %>" />
                </Columns>
