...
{
    public partial class RoleRank_Email_In_TradeCount : BasePage
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT  top 100 ROW_NUMBER() OVER(order by F_TradeCount " + Request.QueryString["order"] + ") AS rownum, F_BigZone,F_ZoneID,F_UserID, F_RoleID, F_TradeCount FROM T_Money_Email_In_TradeCount_GSLog_Rank with(nolock) where 1=1 " + sqlwhere + " ";
