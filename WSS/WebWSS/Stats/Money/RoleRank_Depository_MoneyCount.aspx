<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRank_Depository_MoneyCount.aspx.cs" Inherits="WebWSS.Stats.Money.RoleRank_Depository_MoneyCount" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="交易金额" DataField="F_MoneyCount" DataFormatString="{0:#,#0}" />
