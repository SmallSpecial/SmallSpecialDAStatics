<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleRank_Depository_TradeCount.aspx.cs"
    Inherits="WebWSS.Stats.Money.RoleRank_Depository_TradeCount" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="<%$Resources:Language,LblFrequency %>" DataField="F_TradeCount" DataFormatString="{0}次" />
