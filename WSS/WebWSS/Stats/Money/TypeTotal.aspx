<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeTotal.aspx.cs" Inherits="WebWSS.Stats.Money.TypeTotal" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银币总计"></asp:Label>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField HeaderText="<%$Resources:Language,LblDate %>" DataField="F_Date" DataFormatString="{0:yyyy-MM-dd}" />
                    <asp:TemplateField  HeaderText="战区">
                        <ItemTemplate>
                            <%#FormatZoneName(Eval("F_zoneId").ToString()) %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="金钱数量" DataField="F_MoneyCount" DataFormatString="{0:#,#0}" />
                </Columns>
