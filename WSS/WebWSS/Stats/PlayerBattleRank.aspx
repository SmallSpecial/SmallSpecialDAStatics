<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlayerBattleRank.aspx.cs" Inherits="WebWSS.Stats.PlayerBattleRank" %>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId1")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName1") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo1") + "<br/>" + GetResource("LblBattle") +" :" + Eval("ObjectThdIntInfo1") %>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo1" HeaderText="<%$Resources:Language,LblBattle %>" />
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId2")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName2") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo2") + "<br/>" + GetResource("LblBattle") +" :" + Eval("ObjectThdIntInfo2") %>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo2" HeaderText="<%$Resources:Language,LblBattle %>" />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId3")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName3") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo3") + "<br/>" + GetResource("LblBattle") +" :" + Eval("ObjectThdIntInfo3")%>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo3" HeaderText="<%$Resources:Language,LblBattle %>" />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId4")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName4") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo4") + "<br/>" + GetResource("LblBattle") +" :" + Eval("ObjectThdIntInfo4") %>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo4" HeaderText="<%$Resources:Language,LblBattle %>" />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#GetResource("LblUserNo")+"：" + Eval("ObjectId")+"<br/>"+GetResource("UserName")+ " :" + Eval("ObjectName") + " <br />"+GetResource("LblLevel")+":" + Eval("ObjectIntInfo") + "<br/>" + GetResource("LblBattle") +" :" + Eval("ObjectThdIntInfo") %>
                                </span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="ObjectThdIntInfo" HeaderText="<%$Resources:Language,LblBattle %>" />
