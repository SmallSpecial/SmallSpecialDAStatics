<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleVocationPKHonorRank.aspx.cs"
    Inherits="WebWSS.Stats.RoleVocationPKHonorRank" %>
...
<body style="overflow-x: hidden; overflow-y: scroll;" onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text=" <%$Resources:Language,LblPkHonorRankStatis %>"></asp:Label>
        </div>
        <div class="search">
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID1").ToString().Length == 0 ? "" :  GetResource("LblNo")+ " :" + Eval("F_RoleID1") + GetResource(" LblLevel" )+ " :"  + Eval("F_Level1") + " <br />"+GetResource("LblPkHonor")+":" + Eval("F_PKHonor1") +  " <br />"+ GetZoneName(Eval("F_BigZone1"), Eval("F_ZoneID1")) + " <br />"+ GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime1") +  "<br/>"+GetResource("LblUpdateTime")+ " :"  + Eval("F_LastTime1") + "  "%></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField >
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID2").ToString().Length == 0 ? "" :  GetResource("LblNo")+ " :" +Eval("F_RoleID2") +GetResource(" LblLevel" )+ " :" + Eval("F_Level2") + " <br />"+GetResource("LblPkHonor")+":" + Eval("F_PKHonor2") + " <br />"+ GetZoneName(Eval("F_BigZone2"), Eval("F_ZoneID2")) + " <br />"+GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime2") + "<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime2") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID3").ToString().Length == 0 ? "" :  GetResource("LblNo")+ " :" + Eval("F_RoleID3") + GetResource(" LblLevel" )+ " :"  + Eval("F_Level3") + " <br />"+GetResource("LblPkHonor")+":"+ Eval("F_PKHonor3") +  " <br />"+ GetZoneName(Eval("F_BigZone3"), Eval("F_ZoneID3")) + " <br />"+ GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime3") +  "<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime3") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID4").ToString().Length == 0 ? "" :  GetResource("LblNo")+ " :" + Eval("F_RoleID4") + GetResource(" LblLevel" )+ " :"  + Eval("F_Level4") +" <br />"+GetResource("LblPkHonor")+":"+ Eval("F_PKHonor4") + " <br />"+ GetZoneName(Eval("F_BigZone4"), Eval("F_ZoneID4")) + " <br />"+GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime4") +  "<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime4") + "  "%></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Language,LblAllVocation %>">
                        <ItemTemplate>
                            <a class="tooltips" href="#tooltips">
                                ...
                                <span>
                                    <%#Eval("F_RoleID99").ToString().Length == 0 ? "" :  GetResource("LblNo")+ " :" + Eval("F_RoleID99") + GetResource(" LblLevel" )+ " :" + Eval("F_Level99") + " <br />"+GetResource("LblPkHonor")+":" + Eval("F_PKHonor99") + " <br />"+ GetZoneName(Eval("F_BigZone99"), Eval("F_ZoneID99")) + " <br />"+ GetResource("LblUpGradeTime") +" :"  + Eval("F_LevelUpTime99") +  "<br/>"+GetResource("LblUpdateTime")+ " :" + Eval("F_LastTime99") + "  "%></span>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <div style="display: none">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="F_PKHonor1" HeaderText="猎魔者" />
                        <asp:BoundField DataField="F_PKHonor2" HeaderText="魔导师" />
                        <asp:BoundField DataField="F_PKHonor3" HeaderText="龙战士" />
                        <asp:BoundField DataField="F_PKHonor4" HeaderText="召唤师" />
                        <asp:BoundField DataField="F_PKHonor99" HeaderText="全部" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
