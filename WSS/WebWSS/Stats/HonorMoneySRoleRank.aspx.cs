...
{
    public partial class HonorMoneySRoleRank : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sqlwhere = " where 1=1 and RankId=2";
            //sqlwhere += " and UpdateTime=''"+searchdateB.ToString(SmallDateTimeFormat)  +"''";
        ...
        public  string GetProNameL(object cid)
        {
            try
            {
                return Common.EnumWSS.GetEnumName(typeof(Common.EnumWSS.ENUM_PROFESSION_ID_L), ((Common.EnumWSS.ENUM_PROFESSION_ID_L)(Convert.ToInt32(cid)/6)).ToString());
            }
            catch (System.Exception ex)
            {
                return cid.ToString();
