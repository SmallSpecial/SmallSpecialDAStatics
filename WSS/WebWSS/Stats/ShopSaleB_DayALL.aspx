<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleB_DayALL.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleB_DayALL" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城统计>>商品销售统计"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="titletip">
           ...
           <asp:Label runat="server" Text="<%$ Resources:Language,LblArea %>"></asp:Label>: <span class="tyellow">所有大区</span>  
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_Date" HeaderText="<%$Resources:Language,LblDate %>" DataFormatString="{0:yyyy-MM-dd}" />
                    <asp:TemplateField HeaderText="游戏大区" Visible="false">
                        <ItemTemplate>
                            <%-- <asp:Label ID="Label1" runat="server" Text='<%# GetTypeNameT(DropDownListArea2,Eval("F_BigZone")) %>'></asp:Label>--%>
                        </ItemTemplate>
                        <ItemStyle Width="230px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="游戏战区" Visible="false">
                        <ItemTemplate>
