...
{
    public partial class RoleOnlineLoginOutRank_Two : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            if (DropDownListArea2.SelectedIndex > 0)
            {
                sqlwhere += @" and   nr.F_ZoneID=r.F_ZoneID and r.F_ZoneID=" + DropDownListArea2.SelectedValue.Split(',')[1] + "";
            }

            string sql = "";
            sql = @"SELECT top 100 ROW_NUMBER() OVER(order by F_TradeCount desc) AS rownum ,F_TradeCount,r.F_UserID,r.F_RoleID,nr.F_RoleName  from T_Other_GSLog_Rank  r,T_BaseRoleCreate nr where F_OPID=40053 and  r.F_RoleID =nr.F_RoleID  " + sqlwhere + "";
