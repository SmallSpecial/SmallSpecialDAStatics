<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleItem_GoodsB.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleItem_GoodsB" %>
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_GoodsNum" HeaderText="交易份数" />
