<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSaleItem_ItemsB.aspx.cs"
    Inherits="WebWSS.Stats.ShopSaleItem_ItemsB" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 商城统计>>道具销售统计"></asp:Label>
        </div>
        <div class="search">
