<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneySilverType.aspx.cs"
    Inherits="WebWSS.Stats.MoneySilverType" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>银票产出消耗"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_GoldSum0" HeaderText="装备改造" />
                    <asp:BoundField DataField="F_GoldSum1" HeaderText="拾取" />
                    <asp:BoundField DataField="F_GoldSum2" HeaderText="GM产出" />
                    <asp:BoundField DataField="F_GoldSum3" HeaderText="任务奖励" />
                    <asp:BoundField DataField="F_GoldSum4" HeaderText="洪荒奖励" />
                </Columns>
