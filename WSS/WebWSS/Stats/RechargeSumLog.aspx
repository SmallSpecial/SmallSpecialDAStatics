<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeSumLog.aspx.cs" Inherits="WebWSS.Stats.RechargeSumLog" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            >><asp:Label runat="server" Text="<%$ Resources:Language,LblRechargeSumLog %>"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_InsertTime" HeaderText="<%$ Resources:Language,LblDate %>"  />
                    <asp:BoundField DataField="SumAmount" HeaderText="<%$ Resources:Language,LblAmount %>"  />
                    <asp:BoundField DataField="PeopleCount" HeaderText="<%$ Resources:Language,LblPeopleNum %>"  />
