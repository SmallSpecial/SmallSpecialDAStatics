<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicSaleLevel.aspx.cs"
    Inherits="WebWSS.Stats.PublicSaleLevel" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text=" 拍卖行统计>>道具等级分布"></asp:Label>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    <asp:BoundField DataField="F_Level" HeaderText="需求等级" DataFormatString="{0} 级" >
