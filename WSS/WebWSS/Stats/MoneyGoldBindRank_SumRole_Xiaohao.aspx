<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldBindRank_SumRole_Xiaohao.aspx.cs"
    Inherits="WebWSS.Stats.MoneyGoldBindRank_SumRole_Xiaohao" %>
            ...
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="GoldSum" HeaderText="元宝数"></asp:BoundField>
                        <asp:BoundField DataField="GoldTime" HeaderText="<%$Resources:Language,LblFrequency %>"></asp:BoundField>
                    </Columns>
