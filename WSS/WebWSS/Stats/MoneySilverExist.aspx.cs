...
{
    public partial class MoneySilverExist : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT convert(varchar(10),F_Date,120) as 日期,F_ZoneID, sum(F_Money) as F_Money  FROM T_MoneySilverExist where F_Date>='" + searchdateB.ToString(SmallDateTimeFormat) + "' and F_Date<='" + searchdateE.ToString(SmallDateTimeFormat) + "' ";
            ...
            sql += " group by F_Date ,F_ZoneID order by F_Date desc";
