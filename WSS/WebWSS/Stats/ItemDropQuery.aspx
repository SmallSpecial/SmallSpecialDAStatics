<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemDropQuery.aspx.cs"
    Inherits="WebWSS.Stats.ItemDropQuery" %>
...
<body onLoad="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            <asp:Label ID="LabelTitle" runat="server" Text="道具统计>>掉落日志查询"></asp:Label>
        </div>
        <div class="search">
          <asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>:
            ...
            掉落类型:<asp:DropDownList ID="DropDownListCType" runat="server" Width="120">
            ...
            &nbsp; 用户/怪编号:<asp:TextBox ID="tboxUID" runat="server" Width="40px" MaxLength="16"></asp:TextBox>
            ...
            &nbsp; 道具ID:<asp:TextBox ID="tboxContent" runat="server" Width="80px" MaxLength="6"></asp:TextBox>
        ...
        <div class="gridv">
            <div id="PanelPage" runat="server" style="background-color: #005A8C; width: 96%;">
               ...
               <%--         <asp:BoundField DataField="ID" HeaderText="日志编号" DataFormatString="{0}">
                        ...
                        <asp:TemplateField HeaderText="用户/怪">
                            <ItemTemplate>
                                <%#GetNPCName(Eval("UID").ToString(), Eval("CID").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
<%--                        <asp:BoundField DataField="CID" HeaderText="<%$Resources:Language,LblRoleNo %>">
                        ...
                        <asp:BoundField DataField="PARA_2" HeaderText="场景ID">
                            <ItemStyle Width="80px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="OPID" HeaderText="掉落类型">
                            <ItemStyle Width="80px" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="OP_BAK" HeaderText="道具GUID">
