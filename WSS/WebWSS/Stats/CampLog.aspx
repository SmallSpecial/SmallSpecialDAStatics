<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampLog.aspx.cs" Inherits="WebWSS.Stats.CampLog" %>
...
<body onload="remove_loading();">
    ...
    <div class="main">
        <div class="itemtitle">
            ...
            <asp:Label runat="server" Text="<%$ Resources:Language,LblCampLog %>"></asp:Label>
        </div>
        <div class="search">
            ...
            &nbsp;
            <%--<asp:Label runat="server" Text="<%$ Resources:Language,LblBigZone %>"></asp:Label>--%>
            <asp:Label runat="server" Text="<%$ Resources:Language,LblCamp %>"></asp:Label>:
            <asp:DropDownList ID="DropDownList1" runat="server" Width="120" AutoPostBack="True">
                <asp:ListItem Text="<%$ Resources:Language,LblAll %>" Value=""></asp:ListItem>
                <asp:ListItem Text="<%$ Resources:Language,LblLM %>" Value="1"></asp:ListItem>
                <asp:ListItem Text="<%$ Resources:Language,LblHD %>" Value="2"></asp:ListItem>
            </asp:DropDownList>
            &nbsp;
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="nLevel" HeaderText="<%$Resources:Language,LbPlayerLevel %>" />
                    <asp:TemplateField HeaderText="<%$Resources:Language,LblCamp %>">
                            <ItemTemplate>
                                <%#GetCampName(Eval("UnionId").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    <asp:BoundField DataField="MeritLevel"  HeaderText="<%$Resources:Language,LbMeritLevel %>" />
                </Columns>
                <PagerTemplate>
