...
{
    public partial class ChatRoleNumRank : Admin_Page
    {
        ...
        public void bind()
        {
            ...
            string sql = "";
            sql = @"SELECT top 100 ROW_NUMBER() OVER(order by F_Num desc) AS rownum,F_UserID, F_RoleID, F_Num from T_ChatRoleNumRank where 1=1 " + sqlwhere + " ";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (lblerro.Visible)
                    {
                        (e.Row.Cells[4].FindControl("LinkButtonDetail") as LinkButton).Visible=false;
                    }
                }
            }
            catch (System.Exception ex)
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Detail")
            {
                ...
                string url = "ChatQuery.aspx?cid=" + datakey["F_RoleID"].ToString() + "&date=" + LabelTime.Text;
