<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopBaseItemImport.aspx.cs"
    Inherits="WebWSS.Shop.ShopBaseItemImport" %>
        ...
        <div class="gridv" id="divMain" runat="Server">
            ...
            <asp:GridView ID="GridView1" runat="server" Font-Size="12px" Width="95%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_ITEMPRICE" HeaderText="参考价格" />
                </Columns>
