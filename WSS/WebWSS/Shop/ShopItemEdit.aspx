<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopItemEdit.aspx.cs" Inherits="WebWSS.Shop.ShopItemEdit" %>
        ...
        <div style="border: 1px solid #0099CC; background-color: white; width: 99%;">
            <table style="margin: 30px 5px 40px 60px;">
                    ...
                    <td style="font-weight: bold;">
                        商品编号:<asp:Label ID="lblItemID" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr height="36px">
                    <td style="font-weight: bold;">
                ...
                <tr height="36px">
                    <td>
                        ...
                        <span style="color: #eb1291;">
                            ...
                            &nbsp; </span>限时时段<asp:TextBox ID="tboxLTBegin" runat="server" 
                            Width="150px" Enabled="False">2013-01-01 00:00</asp:TextBox>-<asp:TextBox
                                ID="tboxLTEnd" runat="server" Width="169px" Enabled="False">2013-01-01 00:00</asp:TextBox><br />
                    </td>
                </tr>
                <tr  height="36px" style="font-weight: bold;">
                    <td>
                        商品数量:<asp:TextBox ID="tboxNum" runat="server" Width="51px" MaxLength="3" 
                            AutoPostBack="True" ontextchanged="tboxNum_TextChanged">1</asp:TextBox>
                        &nbsp;商品顺序:<span style="color: #eb1291;"><asp:TextBox ID="tboxPos" runat="server"
                            Width="33px" MaxLength="3">0</asp:TextBox>
                        </span>&nbsp;商品类型:<asp:DropDownList ID="ddlItemType" runat="server" 
                ...
                <tr height="36px" style="font-weight: bold;">
                    <td>
                        描述:<asp:TextBox ID="tboxNote" runat="server" Height="73px" 
                            TextMode="MultiLine" Width="475px" Enabled="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">
                        <div style="float: right; margin-right: 2px;margin-top:16px;">
                         <span runat="Server" id="spanTips" style="font-weight: bold;color:#0c9bba;margin-right: 10px;width:240px"> 
                            ...
                            &nbsp; <asp:Button ID="btnCommit" runat="server" Text="保 存" CssClass="button"
