...
namespace WSS.DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        public int ExecuteMySql(string SQLString)
        {
        ...
        public DataSet QueryForMysql(string SqlString)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
        ...
        public DataSet RunProcedureMysql(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                sqlDA.SelectCommand = BuildQueryCommandMy(connection, storedProcName, parameters);
        ...
        private static MySqlCommand BuildQueryCommandMy(MySqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
