...
function inittypelist()
{
    ...
    var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=product&m_id="+document.getElementById("selectflag").value;
...
{
    var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=product&PT_ID="+id+"&m_id="+document.getElementById("selectflag").value;
	var XMLDoc1=new XMLHttpObject(url,false);
	XMLDoc1.sendData();
	var msg = XMLDoc1.getText(); 
...
{
   var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=showlist";
   var XMLDoc1=new XMLHttpObject(url,false);
   XMLDoc1.sendData();
   var msg = XMLDoc1.getText();
   var strmsg = msg.split('$');
...
{
    var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=showlist&SHT_ID="+id;
    alert(url);
	var XMLDoc1=new XMLHttpObject(url,false);
	XMLDoc1.sendData();
	var msg = XMLDoc1.getText(); 
...
function getprocessprodtype()
{
   ...
   var url = document.getElementById("hidweburl").value +"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=processlist";
...
function selectprocesstype(id,obj)
{
    ...
    var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=processlist&MT_ID="+id;
	var XMLDoc1=new XMLHttpObject(url,false);
	XMLDoc1.sendData();
	var msg = XMLDoc1.getText(); 
	var strmsg = msg.split('$');
...
{
   var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=suogateselist";
...
function selectsuogateype(id,obj)
{
   ...
   var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=suogateselist&IT_ID="+id;
	var XMLDoc1=new XMLHttpObject(url,false);
	XMLDoc1.sendData();
	var msg = XMLDoc1.getText(); 
	var strmsg = msg.split('$');
...
{
   var url = document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=serverlist";
   var XMLDoc1=new XMLHttpObject(url,false);
   XMLDoc1.sendData();
   var msg = XMLDoc1.getText();
   var strmsg = msg.split('$');
...
function selectserverype(id,obj)
{
    ...
    var url =document.getElementById("hidweburl").value+"AdminCDNN/GetTreeType."+document.getElementById("hidsuffix").value+"?type=serverlist&ST_ID="+id;
