<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineHour.aspx.cs"
    Inherits="WSS.Web.AdminF.Stats.RoleOnlineHour" %>
...
<body>
    ...
    <div class="main">
        <div class="itemtitle">
            <h3>
                <asp:Label ID="LabelTitle" runat="server" Text=" 在线统计>>玩家在线统计"></asp:Label></h3>
        </div>
        <div class="search">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LoginNum" HeaderText="登录次数" />
                    <asp:BoundField DataField="F_LoginIpNum" HeaderText="登录IP" />
