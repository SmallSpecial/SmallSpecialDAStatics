<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOnLineHistory.aspx.cs" Inherits="WSS.Web.AdminF.Stats.UserOnLineHistory" %>
    ...
    <div class="main">
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                PageSize="25">
                <Columns>
                <asp:BoundField DataField="F_ID" HeaderText="日期" SortExpression="F_ID"  DataFormatString="2012-3-{0}" />
