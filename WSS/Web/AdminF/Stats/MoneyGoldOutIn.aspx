<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyGoldOutIn.aspx.cs" Inherits="WSS.Web.AdminF.Stats.MoneyGoldOutIn" %>
...
<body>
    ...
    <div class="main">
        <div class="itemtitle">
            <h3>
                <asp:Label ID="LabelTitle" runat="server" Text=" 金钱统计>>金币产出消耗"></asp:Label></h3>
        </div>
        <div class="search">
            大区:
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="产出" HeaderText="产出"   />
                    <asp:BoundField DataField="消耗" HeaderText="消耗"   />
                    <asp:BoundField DataField="结余" HeaderText="结余" />
