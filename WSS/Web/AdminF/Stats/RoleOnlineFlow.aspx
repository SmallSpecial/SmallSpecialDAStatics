<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineFlow.aspx.cs"
    Inherits="WSS.Web.AdminF.Stats.RoleOnlineFlow" %>
...
<body>
    ...
    <div class="main">
        <div class="itemtitle">
            <h3>
                <asp:Label ID="LabelTitle" runat="server" Text=" 在线统计>>角色在线(每小时) "></asp:Label></h3>
        </div>
        <div class="search">
            大区:
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_Time" HeaderText="时 间" DataFormatString="{0}点" />
