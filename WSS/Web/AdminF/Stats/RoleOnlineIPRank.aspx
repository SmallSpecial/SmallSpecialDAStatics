<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleOnlineIPRank.aspx.cs"
    Inherits="WSS.Web.AdminF.Stats.RoleOnlineIPRank" %>
...
<body>
    ...
    <div class="main">
        <div class="itemtitle">
            <h3>
                <asp:Label ID="LabelTitle" runat="server" Text=" 在线统计>>IP登录次数排行"></asp:Label></h3>
        </div>
        <div class="search">
            大区:
        ...
        <div class="gridv">
            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="F_LoginIP" HeaderText="登录IP" />
                    <asp:BoundField DataField="F_LoginNum" HeaderText="登录次数" />
                    <asp:BoundField DataField="F_UserName" HeaderText="用户数量" />
