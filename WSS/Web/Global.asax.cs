...
namespace WSS.Web 
{
	...
	public class Global : System.Web.HttpApplication
	{
		...
		{
         //System.Data.SqlClient.SqlDependency.Start(System.Configuration.ConfigurationManager.ConnectionStrings["UserDB"].ConnectionString);
		...
		protected void Session_Start(Object sender, EventArgs e)
		{
            ...
            //    if (tempStr != "")
            //    {                                      
            //        if (tempStr.Trim().StartsWith("www..com"))
            //        {
