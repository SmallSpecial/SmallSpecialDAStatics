...
namespace WSS.Web.Admin.GameTool
{
    ...
    public class GameServers : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (GameCode == "100001")
                {
                    ...
                    string WebSUrl = System.Configuration.ConfigurationManager.AppSettings["WebserviceGameCoreDB"];
