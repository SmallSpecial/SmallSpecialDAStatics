<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubNotice.aspx.cs" ValidateRequest="false"
    Inherits="WSS.Web.Admin.SysManage.PubNotice" %>
...
<script runat="server">
    ...
    {
        object F_Value = e.NewValues["F_Title"];
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager2" runat="server">
        <Scripts>
           <asp:ScriptReference Path="../../js/ext-lang-zh_CN.js" />
      </Scripts>
</asp:ScriptManager> 

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebServeDBConnectionString %>"
        DeleteCommand="DELETE FROM [T_PubNotice] WHERE [F_ID] = @F_ID" InsertCommand="INSERT INTO [T_PubNotice] ([F_Title], [F_Note], [F_DateTime]) VALUES (@F_Title, @F_Note, getdate())"
        SelectCommand="SELECT [F_ID], [F_Title], [F_Note], [F_DateTime] FROM [T_PubNotice]"
        UpdateCommand="UPDATE [T_PubNotice] SET [F_Title] = @F_Title, [F_Note] = @F_Note, [F_DateTime] = getdate() WHERE [F_ID] = @F_ID">
        <DeleteParameters>
                    ...
                    <ext:Panel ID="Panel2" runat="server" Height="300" Header="false">
                        <Body>
                            <ext:FitLayout ID="FitLayout1" runat="server">
                                <ext:GridPanel ID="GridPanel1" runat="server" Title="公告管理" AutoExpandColumn="F_Note"
                                    StoreID="Store1" Border="false" Icon="BellGo" SelectionMemory="Disabled" TrackMouseOver="True">
                                    <ColumnModel ID="ColumnModel1" runat="server">
                                        <Columns>
                                            <ext:Column ColumnID="F_ID" DataIndex="F_ID" Header="编号" Width="20px">
                                            </ext:Column>
                                            <ext:Column DataIndex="F_Title" Header="标题" Width="40px">
                                                <Editor>
                                                    <ext:TextField ID="TextField2" runat="server" MaxLength="50" AllowBlank="False" BlankText="标题不能为空" MaxLengthText="标题最大长度为50" />
                                                </Editor>
                                            </ext:Column>
                                            ...
                                            <Renderer Fn="trimhtml" />
                                                <Editor>
                                                    ...
                                                    <%--<ext:TextField ID="TextField3" runat="server" MaxLength="500" />--%>
                                                </Editor>
                                            </ext:Column>
                                            <ext:Column DataIndex="F_DateTime" Header="添加时间" Width="30px">
                       ...
                       <hr /> <p><b>标题:</b> {F_Title}</p><br/>
                        ...
                        <p><b>内容:</b></p><p> {F_Note}</p><hr />
                            ...
                            <Filters>
                                ...
                                <ext:StringFilter DataIndex="F_Title" />
                                <ext:StringFilter DataIndex="F_Note" />
                                <ext:DateFilter DataIndex="F_DateTime">
                                    <DatePickerOptions runat="server" TodayText="当天"></DatePickerOptions>
                                </ext:DateFilter>
                            </Filters>
                        </ext:GridFilters>
