<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOnlineDayAreaMap.aspx.cs"
    Inherits="WSS.Web.StatF.UserOnlineDayAreaMap" %>
        ...
        <Body>
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                ...
                <%--                    <ext:Button ID="Button7" runat="server" Text="导出矩形图片" Icon="Picture">
                        ...
                        <Tabs>
                            <ext:Tab ID="Tab1" runat="server" Title="分布图" Icon="Map" AutoScroll="true" BodyStyle="padding: 2px;">
                                <Body>
