<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOnlineDayPCU.aspx.cs" Inherits="WSS.Web.StatF.UserOnlineDayPCU" %>
...
<head runat="server">
    ...
    <script runat="server">
        ...
        private void SetChart()
        {
            ...
            chartitle = "PCU走势[" + Convert.ToDateTime(this.FromDate.Value).ToShortDateString() + "至" + Convert.ToDateTime(this.ToDate.Value).ToShortDateString() + "]";
            xmlData.Append("<chart  exportEnabled='1' refresh='1' exportAction='Download' exportShowMenuItem = '0'  exportfilename='SLYCharts' exportAtClient='0' exportHandler='Export_Handler/FCExporter.aspx' exportDialogMessage='数据转换中,请稍候...' animation='1' caption='" + chartitle + "' xAxisName='日期' yAxisName='人数' showValues='0' labelDisplay='ROTATE' slantLabels='1'  formatNumberScale='0' showBorder='1' aboutMenuItemLabel='关于 神龙游' aboutMenuItemLink='#' lineColor='#F1683C' ColumnColor='#129bee' numVDivLines='10' >");

            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                DateTime dateS = Convert.ToDateTime(dr["F_Month"] + "-" + dr["F_Month"] + "-" + dr["F_Day"] + "");
                xmlData.Append("<set label='" + dateS.ToString("MM-dd周ddd") + "' value='" + dr["F_PCU"] + "' />");
            }
            ...
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                <North MarginsSummary="5 5 5 5">
                    <ext:Panel ID="Panel1" runat="server" Title="描述" Height="60" BodyStyle="padding: 5px;"
                        ...
                        <Body>
                           PCU走势  &nbsp;&nbsp;&nbsp;ACU:平均在线 PCU:是高在线 &nbsp;[统计日期默认为最近30天]
                        </Body>
                    </ext:Panel>
                </North>
