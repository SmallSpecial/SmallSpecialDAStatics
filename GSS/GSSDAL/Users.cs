...
namespace GSSDAL
{
    ...
    public partial class Users
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select F_UserID,F_UserName,F_PassWord,F_DepartID,F_RoleID,F_RealName,F_Sex,F_Birthday,F_Email,F_MobilePhone,F_Telphone,F_Note,F_RegTime,F_LastInTime,F_IsUsed ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" F_UserID,F_UserName,F_PassWord,F_DepartID,F_RoleID,F_RealName,F_Sex,F_Birthday,F_Email,F_MobilePhone,F_Telphone,F_Note,F_RegTime,F_LastInTime,F_IsUsed ");
            strSql.Append(" FROM T_Users ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
