...
{
    public partial class ARichTextBoxEE : RichTextBox
    {
        #region 变量
        //属性
        /// <summary>
        ...
        public ARichTextBoxEE()
        {
            InitializeComponent();
        }

        public ARichTextBoxEE(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
        ...
        protected override void OnCreateControl()
        {
            ...
            this.全选ToolStripMenuItem.Text = LanguageResource.Language.BtnSelectAll;
