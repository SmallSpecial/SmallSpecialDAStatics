...
namespace GSSUI.AControl.AThirTreeView
{
    ...
    abstract public class TriStateTreeView : System.Windows.Forms.TreeView
    {
        ...
        internal Dictionary<TreeNode, CheckBoxState> _NodeStateDict = new Dictionary<TreeNode, CheckBoxState>();
        #endregion
        ...
        internal void SetParentTreeNodeStateRecursively(TreeNode parentTreeNode)
        {
        ...
        /// <param name="treeNode">tree node</param>
        /// <param name="checkboxState">checkbox state</param>
        internal void SetTreeNodeState(TreeNode treeNode, CheckBoxState checkboxState)
        {
            IntPtr hWnd;
            TVITEM tvi;
            hWnd = this.Handle;
