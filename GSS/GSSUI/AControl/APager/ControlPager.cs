...
{
    public partial class ControlPager : UserControl
    {
        public void SetLanguageText()
        {
            lblMsg1.Text = LanguageResource.Language.LblTotal;
            lblMsg2.Text = LanguageResource.Language.LblRecords;
            lblMsg3.Text = LanguageResource.Language.LblEachPage;
            lblMsg4.Text = LanguageResource.Language.LblStrip;
            lnkFirst.Text = LanguageResource.Language.LblHome;
            lnkPrev.Text = LanguageResource.Language.LblNext;//注意这里的控件ID和文本起始命名是错误的
            lnkNext.Text = LanguageResource.Language.LblPrevious;
            lnkLast.Text = LanguageResource.Language.LblShadowe;
            btnGo.Text = LanguageResource.Language.LblGoto;
        }
        public ControlPager()
        {
            InitializeComponent();
