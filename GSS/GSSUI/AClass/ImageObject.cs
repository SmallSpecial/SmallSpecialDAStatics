...
namespace GSSUI.AClass
{
    public static class ImageObject
    {
        ...
        public static Image ProcImage(Bitmap bitmap, Color color)
        {

            Colors.HslColor dd = new Colors.RgbColor(color.R,color.G, color.B).ToHslColor();
            return ProcImage((Image)bitmap,dd.Hue,dd.Saturation,dd.Light);
        }
