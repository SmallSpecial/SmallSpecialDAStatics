...
namespace GSSUI
{
    public partial class FormUI : Form
    {
        ...
        [Browsable(true), Description("需要显示的皮肤目录"), Category("GSSUI")]
        ...
        [Browsable(true), Description("窗体标题字体"), Category("GSSUI")]
        ...
        [Browsable(true), Description("是否允许调整窗体大小"), Category("GSSUI")]
        ...
        [Browsable(true), Description("是否允许鼠标移动窗体"), Category("GSSUI")]
        public bool CanMove
        {
            get { return _canMove; }
            set { _canMove = value; }
        ...
        [Browsable(true), Description("是否允许选择皮肤按钮"), Category("GSSUI")]
        ...
        private void FormUI_MouseMove(object sender, MouseEventArgs e)
        {
            #region 拖动边框大小
        ...
        //双击标题栏
        private void FormUI_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            if (MaximizeBox)
            {
        ...
        private void InitDefaultSkin()
        {
            ...
            //顶部
            _topLeft.Height = _topMiddle.Height = _topRight.Height = 31;
            _topLeft.Width = 10;
            _topRight.Width = 10;

            //底部
            _bottomLeft.Height = _bottomMiddle.Height = _bottomRight.Height = 37;
            _bottomLeft.Width = 10;
            _bottomRight.Width = 10;

            //中部
            _centerLeft.Width = 2;
            _centerRight.Width = 2;

            minButton.Width = 35;
            minButton.Height = 20;
            minButton.XOffset = 70;
            minButton.Top = 0;

            maxButton.Width = 35;
            maxButton.Height = 20;
            maxButton.XOffset = 36;
            maxButton.Top = 0;
            ...
            selectSkinButton.XOffset = 115;
            selectSkinButton.Top = 2;

            #endregion

           CaculatePartLocation();

          #region 读取图片GSSUI.Properties.Resources.TopRight


           _topLeft.BackgroundBitmap = GSSUI.Properties.Resources.TopLeft;
           _topMiddle.BackgroundBitmap =GSSUI.Properties.Resources.TopMiddle;
           _topRight.BackgroundBitmap = GSSUI.Properties.Resources.TopRight;

           _centerLeft.BackgroundBitmap = GSSUI.Properties.Resources.MiddleLeft;
           _centerMiddle.BackgroundBitmap = GSSUI.Properties.Resources.Middle;
           _centerRight.BackgroundBitmap = GSSUI.Properties.Resources.MiddleRight;


           _bottomLeft.BackgroundBitmap = GSSUI.Properties.Resources.BottomLeft;
           _bottomMiddle.BackgroundBitmap = GSSUI.Properties.Resources.BottomMiddle;
           _bottomRight.BackgroundBitmap = GSSUI.Properties.Resources.BottomRight;

           minButton.ReadButtonImage(
              GSSUI.Properties.Resources.MinNormal,
              GSSUI.Properties.Resources.MinMove,
              GSSUI.Properties.Resources.MinDown
               );

           maxButton.ReadButtonImage(
              GSSUI.Properties.Resources.MaxNormal,
              GSSUI.Properties.Resources.MaxMove,
              GSSUI.Properties.Resources.MaxDown
               );
           closeButton.ReadButtonImage(
              GSSUI.Properties.Resources.CloseNormal,
              GSSUI.Properties.Resources.CloseMove,
              GSSUI.Properties.Resources.CloseDown
               );
           selectSkinButton.ReadButtonImage(
              GSSUI.Properties.Resources.SelectSkinNormal,
              GSSUI.Properties.Resources.SelectSkinMove,
              GSSUI.Properties.Resources.SelectSkinDown
               );
