            ...
            if (closeBoxVisibale)
            {
                if (closeBoxRect.Contains(mousePoint))
                {
                    ...
                    if (!_mouseDown)
                    {
                        ...
                        {
                            toolTip = LanguageResource.Language.BtnClose;
                        }
            ...
            if (minimizeBoxVisibale)
            {
                if (minimizeBoxRect.Contains(mousePoint))
                {
                    ...
                    if (!_mouseDown)
                    {
                        ...
                        {
                            toolTip = LanguageResource.Language.BtnMin;
                        }
                ...
                if (maximizeBoxRect.Contains(mousePoint))
                {
                    ...
                    if (!_mouseDown)
                    {
                        if (MaximizeBoxState != ControlBoxState.Hover)
                        {
                            ...
                            toolTip = maximize ? LanguageResource.Language.BtnRestore : LanguageResource.Language.BtnMax;
                        }
