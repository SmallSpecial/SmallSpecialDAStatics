...
{
    public partial class FormGameConfig : Form
    {
        public FormGameConfig()
        {
            InitializeComponent();
        }

        private void FormGameConfig_Load(object sender, EventArgs e)
        {
        ...
        {
            FormGameConfigAdd form = new FormGameConfigAdd(0);
            form.ShowDialog();
        }
        ...
        private void toolStripButtonEdit_Click(object sender, EventArgs e)
        {
            ...
            FormGameConfigAdd form = new FormGameConfigAdd(id);
            form.ShowDialog();
        }
