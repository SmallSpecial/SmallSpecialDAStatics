...
namespace GSSClient
{
    public partial class FormTaskEditGA : GSSUI.AForm.FormMain
    {
        #region 私有变量
        /// <summary>
        /// 客户端处理类
        ...
        /// 构造函数
        /// </summary>
        public FormTaskEditGA(ClientHandles clihandle, int taskid)
        {
            InitializeComponent();
        ...
        private void CommitTask(bool gnstate)
        {
            ...
            if (backStr == "true")
            {
                ...
                SetGameUR();
                MsgBox.Show(operatStr + "成功!", "提示信息.", MessageBoxButtons.OK, MessageBoxIcon.Information);
