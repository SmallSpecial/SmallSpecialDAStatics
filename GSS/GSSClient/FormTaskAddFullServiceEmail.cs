...
namespace GSSClient
{
    public class FormTaskAddFullServiceEmail : GSSUI.AForm.FormMain
    {
        ...
        private UserControlDLL.ComCheckBoxList cmbZone;
        private ClientHandles _clienthandle;
        public FormTaskAddFullServiceEmail(ClientHandles clienthandle, string title, int workorderTypeID)
        {
            InitializeComponent();
            ...
            this.dtpStart.CustomFormat = "yyyy-MM-dd HH:mm:ss";//timeFormat;
            this.dtpStart.Format = DateTimePickerFormat.Custom;
            this.dtpEnd.CustomFormat = "yyyy-MM-dd HH:mm:ss";//timeFormat;
        ...
        private void InitializeComponent()
        {
            ...
            this.cmbZone = new UserControlDLL.ComCheckBoxList();
            this.SuspendLayout();
            // 
            // txtMinLevel
            // 
            ...
            this.txtMaxLevel.Size = new System.Drawing.Size(103, 21);
            ...
            this.cmbZone.Size = new System.Drawing.Size(103, 20);
            this.cmbZone.TabIndex = 2223386;
            // 
            // FormTaskAddFullServiceEmail
            // 
            ...
            this.Name = "FormTaskAddFullServiceEmail";
        ...
        void BindComboBoxList(GSSModel.Response.GameConfig[] items)
        {
            DataTable dt = new DataTable();
            DataColumn dc1 = new DataColumn("GameValue", typeof(System.String));
            dt.Columns.Add(dc1);
            ...
            {
                if (items[i].GameValue != "-1")
                {
                    DataRow dr = dt.NewRow();
                    dr[0] = items[i].GameValue;
                    dr[1] = items[i].Name;
                    dt.Rows.Add(dr);
                }
            }
        ...
        private void cmbBigZone_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            BindComboBoxList(allZone.ToArray());
        }
