...
namespace GSSModel
{
    public delegate void CallBack(object data);//声明一个创建直接参数传递的委托
    /// <summary>
    /// 工单表
    /// </summary>
    [Serializable]
    ...
    /// <summary>
    /// 包含工单和逻辑数据的实体类【使用场景，创建工单完成后执行对应的功能】
    /// </summary>
    [Serializable]
    public class TaskContainerLogicData 
    {
        /// <summary>
        /// 工单数据
        /// </summary>
        public Tasks WorkOrder { get; set; }
        /// <summary>
        /// 逻辑数据
        /// </summary>
